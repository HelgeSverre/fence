...
var $author$project$Types$Clean = {$: 'Clean'};
var $author$project$Editor$init = {content: '', dirtyState: $author$project$Types$Clean, filePath: $elm$core$Maybe$Nothing, scrollTop: 0};
...
var $author$project$FileTree$init = {expanded: $elm$core$Set$empty, focused: $elm$core$Maybe$Nothing, root: $elm$core$Maybe$Nothing, rootPath: $elm$core$Maybe$Nothing, selected: $elm$core$Maybe$Nothing};
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{debounceGeneration: 0, editor: $author$project$Editor$init, fileTree: $author$project$FileTree$init, frontmatter: $elm$core$Maybe$Nothing, previewHtml: _List_Nil, settingsOpen: false, theme: ''},
		$elm$core$Platform$Cmd$none);
};
var $author$project$Main$FromElectron = function (a) {
	return {$: 'FromElectron', a: a};
};
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$json$Json$Decode$value = _Json_decodeValue;
var $author$project$Ports$fromElectron = _Platform_incomingPort('fromElectron', $elm$json$Json$Decode$value);
...
var $author$project$Main$subscriptions = function (_v0) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				$author$project$Ports$fromElectron($author$project$Main$FromElectron),
				$elm$browser$Browser$Events$onKeyDown($author$project$Main$keyDecoder)
			]));
};
var $author$project$Main$DebouncedParse = function (a) {
	return {$: 'DebouncedParse', a: a};
};
...
var $author$project$Types$FileEntry = function (a) {
	return {$: 'FileEntry', a: a};
};
var $author$project$Types$Directory = {$: 'Directory'};
var $author$project$Types$File = {$: 'File'};
var $elm$json$Json$Decode$andThen = _Json_andThen;
var $elm$json$Json$Decode$fail = _Json_fail;
var $author$project$Main$fileTypeDecoder = A2(
	$elm$json$Json$Decode$andThen,
	function (s) {
		switch (s) {
			case 'directory':
				return $elm$json$Json$Decode$succeed($author$project$Types$Directory);
			case 'file':
				return $elm$json$Json$Decode$succeed($author$project$Types$File);
			default:
				return $elm$json$Json$Decode$fail('Unknown file type: ' + s);
		}
	},
...
function $author$project$Main$cyclic$fileEntryDecoder() {
	return A5(
		$elm$json$Json$Decode$map4,
		F4(
			function (name, path, ft, children) {
				return $author$project$Types$FileEntry(
					{children: children, fileType: ft, name: name, path: path});
			}),
		A2($elm$json$Json$Decode$field, 'name', $elm$json$Json$Decode$string),
		A2($elm$json$Json$Decode$field, 'path', $elm$json$Json$Decode$string),
		A2($elm$json$Json$Decode$field, 'fileType', $author$project$Main$fileTypeDecoder),
				...
				$elm$json$Json$Decode$lazy(
					function (_v0) {
						return $elm$json$Json$Decode$list(
							$author$project$Main$cyclic$fileEntryDecoder());
					}))));
}
try {
	var $author$project$Main$fileEntryDecoder = $author$project$Main$cyclic$fileEntryDecoder();
	$author$project$Main$cyclic$fileEntryDecoder = function () {
		return $author$project$Main$fileEntryDecoder;
	};
} catch ($) {
...
var $author$project$Main$dirEntriesDecoder = A3(
...
var $author$project$Main$fileContentDecoder = A3(
	$elm$json$Json$Decode$map2,
	$elm$core$Tuple$pair,
	A2($elm$json$Json$Decode$field, 'path', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'content', $elm$json$Json$Decode$string));
var $author$project$Main$fsEventDecoder = A3(
	$elm$json$Json$Decode$map2,
	$elm$core$Tuple$pair,
...
var $author$project$FileTree$baseName = function (path) {
	return A2(
...
var $author$project$FileTree$freshRoot = F3(
	function (path, entries, model) {
		var rootEntry = $author$project$Types$FileEntry(
			{
				children: $elm$core$Maybe$Just(entries),
				fileType: $author$project$Types$Directory,
				name: $author$project$FileTree$baseName(path),
				path: path
			});
		return _Utils_update(
			model,
			{
				expanded: $elm$core$Set$singleton(path),
				focused: $elm$core$Maybe$Nothing,
				root: $elm$core$Maybe$Just(rootEntry),
				rootPath: $elm$core$Maybe$Just(path),
				selected: $elm$core$Maybe$Nothing
			});
	});
var $author$project$FileTree$insertChildren = F3(
	function (targetPath, entries, _v0) {
		var e = _v0.a;
		if (_Utils_eq(e.path, targetPath)) {
			return $author$project$Types$FileEntry(
				_Utils_update(
					e,
					{
					...
					_Utils_update(
						e,
						{
							children: $elm$core$Maybe$Just(
								A2(
									$elm$core$List$map,
									A2($author$project$FileTree$insertChildren, targetPath, entries),
									children))
						}));
			} else {
				return $author$project$Types$FileEntry(e);
			}
		}
	});
...
var $author$project$FileTree$handleDirContents = F3(
	function (path, entries, model) {
		var _v0 = model.rootPath;
		if (_v0.$ === 'Just') {
			var rp = _v0.a;
			return (_Utils_eq(path, rp) || A2($elm$core$String$startsWith, rp + '/', path)) ? _Utils_update(
				model,
				{
					root: A2(
						$elm$core$Maybe$map,
						A2($author$project$FileTree$insertChildren, path, entries),
						model.root)
				}) : A3($author$project$FileTree$freshRoot, path, entries, model);
		} else {
			return A3($author$project$FileTree$freshRoot, path, entries, model);
		}
	});
...
var $author$project$Types$fileEntryPath = function (_v0) {
	var e = _v0.a;
	return e.path;
};
var $author$project$Types$fileEntryName = function (_v0) {
	var e = _v0.a;
	return e.name;
};
var $author$project$Types$fileEntryType = function (_v0) {
	var e = _v0.a;
	return e.fileType;
};
var $elm$core$List$sortBy = _List_sortBy;
var $elm$core$String$toLower = _String_toLower;
var $author$project$FileTree$sortEntries = function (entries) {
	var files = A2(
		$elm$core$List$sortBy,
		function (en) {
			return $elm$core$String$toLower(
				$author$project$Types$fileEntryName(en));
		},
		A2(
			$elm$core$List$filter,
			function (en) {
				return _Utils_eq(
					$author$project$Types$fileEntryType(en),
					$author$project$Types$File);
			},
			entries));
	var dirs = A2(
		$elm$core$List$sortBy,
		...
		A2(
			...
			function (en) {
				return _Utils_eq(
					$author$project$Types$fileEntryType(en),
					$author$project$Types$Directory);
			},
			entries));
	return _Utils_ap(dirs, files);
};
var $author$project$FileTree$addChild = F3(
	function (parentPath, newEntry, _v0) {
		var e = _v0.a;
		if (_Utils_eq(e.path, parentPath)) {
			var _v1 = e.children;
			if (_v1.$ === 'Just') {
				var children = _v1.a;
				return A2(
					...
					function (c) {
						return _Utils_eq(
							$author$project$Types$fileEntryPath(c),
							$author$project$Types$fileEntryPath(newEntry));
					},
					children) ? $author$project$Types$FileEntry(e) : $author$project$Types$FileEntry(
					_Utils_update(
						e,
						{
							children: $elm$core$Maybe$Just(
								$author$project$FileTree$sortEntries(
									A2($elm$core$List$cons, newEntry, children)))
						}));
			} else {
				return $author$project$Types$FileEntry(e);
			}
					...
					_Utils_update(
						e,
						{
							children: $elm$core$Maybe$Just(
								A2(
									$elm$core$List$map,
									A2($author$project$FileTree$addChild, parentPath, newEntry),
									children))
						}));
			} else {
				return $author$project$Types$FileEntry(e);
...
var $author$project$FileTree$dirName = function (path) {
	var parts = A2(
		$elm$core$List$filter,
		A2($elm$core$Basics$composeL, $elm$core$Basics$not, $elm$core$String$isEmpty),
		A2($elm$core$String$split, '/', path));
...
var $author$project$FileTree$removeChild = F2(
	function (targetPath, _v0) {
		var e = _v0.a;
		var _v1 = e.children;
		if (_v1.$ === 'Just') {
			var children = _v1.a;
				...
				_Utils_update(
					e,
					{
						children: $elm$core$Maybe$Just(
							A2(
								$elm$core$List$map,
								$author$project$FileTree$removeChild(targetPath),
								A2(
									$elm$core$List$filter,
									function (c) {
										return !_Utils_eq(
...
var $author$project$FileTree$handleFsEvent = F3(
	function (event, path, model) {
		var _v0 = model.root;
		if (_v0.$ === 'Nothing') {
			return model;
		} else {
			...
			switch (event) {
				case 'add':
					var entry = $author$project$Types$FileEntry(
						{
							children: $elm$core$Maybe$Nothing,
							fileType: $author$project$Types$File,
							name: $author$project$FileTree$baseName(path),
							path: path
						});
					return _Utils_update(
						model,
						{
							root: $elm$core$Maybe$Just(
								A3(
									$author$project$FileTree$addChild,
									$author$project$FileTree$dirName(path),
									entry,
									root))
						});
				case 'addDir':
					var entry = $author$project$Types$FileEntry(
						{
							children: $elm$core$Maybe$Just(_List_Nil),
							fileType: $author$project$Types$Directory,
							name: $author$project$FileTree$baseName(path),
							path: path
						});
				...
				case 'unlink':
					return _Utils_update(
						...
						{
							root: $elm$core$Maybe$Just(
								A2($author$project$FileTree$removeChild, path, root))
						});
				case 'unlinkDir':
					return _Utils_update(
						model,
...
var $author$project$Editor$markClean = function (model) {
	return _Utils_update(
		model,
		{dirtyState: $author$project$Types$Clean});
};
...
var $author$project$Frontmatter$dropClosingLine = function (s) {
	var _v0 = $elm$core$String$lines(s);
	if (!_v0.b) {
		return s;
	} else {
		var rest = _v0.b;
...
var $author$project$Frontmatter$findClosingHelper = F3(
	function (lines, lineIndex, charOffset) {
		findClosingHelper:
		while (true) {
			if (!lines.b) {
				return $elm$core$Maybe$Nothing;
				...
				var line = lines.a;
				var rest = lines.b;
				var trimmed = $elm$core$String$trimRight(line);
				if ((trimmed === '---') || (trimmed === '...')) {
					return $elm$core$Maybe$Just(charOffset);
				} else {
					var $temp$lines = rest,
						$temp$lineIndex = lineIndex + 1,
						$temp$charOffset = (charOffset + $elm$core$String$length(line)) + 1;
					lines = $temp$lines;
					lineIndex = $temp$lineIndex;
					charOffset = $temp$charOffset;
					continue findClosingHelper;
				}
			}
		}
	});
var $author$project$Frontmatter$findClosing = function (content) {
	return A3(
		$author$project$Frontmatter$findClosingHelper,
		$elm$core$String$lines(content),
		0,
		0);
};
var $author$project$Yaml$Null_ = {$: 'Null_'};
var $author$project$Yaml$problemToString = function (p) {
	switch (p.$) {
		case 'Expecting':
			var s = p.a;
			return 'expecting ' + s;
...
var $author$project$Yaml$deadEndsToString = function (deadEnds) {
	if (!deadEnds.b) {
		return 'unknown parse error';
	} else {
		var first = deadEnds.a;
		return 'Parse error at row ' + ($elm$core$String$fromInt(first.row) + (', col ' + ($elm$core$String$fromInt(first.col) + (': ' + $author$project$Yaml$problemToString(first.problem)))));
	}
};
...
var $author$project$Yaml$spaces = $elm$parser$Parser$chompWhile(
	function (c) {
		return _Utils_eq(
			c,
...
var $author$project$Yaml$List_ = function (a) {
	return {$: 'List_', a: a};
};
var $elm$parser$Parser$Loop = function (a) {
	return {$: 'Loop', a: a};
};
var $author$project$Yaml$Object_ = function (a) {
	return {$: 'Object_', a: a};
};
...
var $author$project$Yaml$checkIndent = function (expectedIndent) {
	return A2(
		$elm$parser$Parser$andThen,
		function (col) {
			return _Utils_eq(col, expectedIndent + 1) ? $elm$parser$Parser$succeed(_Utils_Tuple0) : $elm$parser$Parser$problem(
				'expected indent ' + ($elm$core$String$fromInt(expectedIndent) + (' but got ' + $elm$core$String$fromInt(col - 1))));
		},
		$elm$parser$Parser$getCol);
};
var $author$project$Yaml$Bool_ = function (a) {
	return {$: 'Bool_', a: a};
};
...
var $author$project$Yaml$boolValue = $elm$parser$Parser$oneOf(
	_List_fromArray(
		[
			A2(
			$elm$parser$Parser$map,
			function (_v0) {
				return $author$project$Yaml$Bool_(true);
			},
			$elm$parser$Parser$keyword('true')),
			A2(
			$elm$parser$Parser$map,
			function (_v1) {
				return $author$project$Yaml$Bool_(false);
			},
			...
			$elm$parser$Parser$keyword('yes')),
			A2(
			$elm$parser$Parser$map,
			function (_v3) {
				return $author$project$Yaml$Bool_(false);
			},
			$elm$parser$Parser$keyword('no'))
		]));
var $author$project$Yaml$String_ = function (a) {
	return {$: 'String_', a: a};
};
...
var $author$project$Yaml$unescapeDoubleQuoted = function (s) {
	return A3(
...
var $author$project$Yaml$doubleQuotedString = A2(
	$elm$parser$Parser$keeper,
	A2(
		$elm$parser$Parser$ignorer,
		$elm$parser$Parser$succeed($author$project$Yaml$String_),
		$elm$parser$Parser$symbol('\"')),
	A2(
		$elm$parser$Parser$ignorer,
		A2(
			$elm$parser$Parser$map,
			$author$project$Yaml$unescapeDoubleQuoted,
		...
		$elm$parser$Parser$symbol('\"')));
var $author$project$Yaml$flowKey = $elm$parser$Parser$oneOf(
	_List_fromArray(
		[
			A2(
			$elm$parser$Parser$keeper,
...
var $author$project$Yaml$flowUnquotedString = A2(
	$elm$parser$Parser$andThen,
	function (s) {
		var trimmed = $elm$core$String$trim(s);
		return $elm$core$String$isEmpty(trimmed) ? $elm$parser$Parser$problem('empty flow value') : $elm$parser$Parser$succeed(
			$author$project$Yaml$String_(trimmed));
	},
	$elm$parser$Parser$getChompedString(
		$elm$parser$Parser$chompWhile(
			function (c) {
...
var $author$project$Yaml$nullValue = $elm$parser$Parser$oneOf(
	_List_fromArray(
		[
			A2(
			$elm$parser$Parser$map,
			function (_v0) {
				return $author$project$Yaml$Null_;
			},
...
var $author$project$Yaml$Float_ = function (a) {
	return {$: 'Float_', a: a};
};
var $author$project$Yaml$Int_ = function (a) {
	return {$: 'Int_', a: a};
};
var $elm$core$String$toFloat = _String_toFloat;
var $author$project$Yaml$numberValue = $elm$parser$Parser$backtrackable(
	A2(
		$elm$parser$Parser$andThen,
		function (s) {
			if ($elm$core$String$isEmpty(s) || ((s === '-') || (s === '.'))) {
				return $elm$parser$Parser$problem('not a number');
			} else {
				var _v0 = $elm$core$String$toInt(s);
				if (_v0.$ === 'Just') {
					var i = _v0.a;
					return $elm$parser$Parser$succeed(
						$author$project$Yaml$Int_(i));
				} else {
					var _v1 = $elm$core$String$toFloat(s);
					if (_v1.$ === 'Just') {
						var f = _v1.a;
						return $elm$parser$Parser$succeed(
							$author$project$Yaml$Float_(f));
					} else {
						return $elm$parser$Parser$problem('not a number');
					}
				}
...
var $author$project$Yaml$singleQuotedString = A2(
	$elm$parser$Parser$keeper,
	A2(
		$elm$parser$Parser$ignorer,
		$elm$parser$Parser$succeed($author$project$Yaml$String_),
	...
	A2(
		...
		$elm$parser$Parser$symbol('\'')));
function $author$project$Yaml$cyclic$flowKeyValue() {
	return A2(
		$elm$parser$Parser$keeper,
		A2(
			$elm$parser$Parser$keeper,
			...
			A2(
				...
				A2(
					$elm$parser$Parser$ignorer,
					A2($elm$parser$Parser$ignorer, $author$project$Yaml$flowKey, $author$project$Yaml$spaces),
					$elm$parser$Parser$symbol(':')),
				$author$project$Yaml$spaces)),
		$elm$parser$Parser$lazy(
			function (_v8) {
				return $author$project$Yaml$cyclic$flowValue();
			}));
}
function $author$project$Yaml$cyclic$flowList() {
	return A2(
		$elm$parser$Parser$keeper,
		A2(
			$elm$parser$Parser$ignorer,
			A2(
				$elm$parser$Parser$ignorer,
				$elm$parser$Parser$succeed($author$project$Yaml$List_),
				$elm$parser$Parser$symbol('[')),
			$author$project$Yaml$spaces),
		A2(
			$elm$parser$Parser$ignorer,
			A2(
				$elm$parser$Parser$ignorer,
				$author$project$Yaml$cyclic$flowListItems(),
				$author$project$Yaml$spaces),
			$elm$parser$Parser$symbol(']')));
}
function $author$project$Yaml$cyclic$flowListItems() {
	return $elm$parser$Parser$oneOf(
		_List_fromArray(
			[
				...
				$author$project$Yaml$cyclic$flowListTail()),
				$elm$parser$Parser$succeed(_List_Nil)
			]));
}
function $author$project$Yaml$cyclic$flowListTail() {
	return $elm$parser$Parser$oneOf(
		_List_fromArray(
			[
				A2(
				...
				$elm$parser$Parser$lazy(
					function (_v6) {
						return $author$project$Yaml$cyclic$flowListTail();
					})),
				$elm$parser$Parser$succeed(_List_Nil)
			]));
}
function $author$project$Yaml$cyclic$flowObject() {
	return A2(
		$elm$parser$Parser$keeper,
		A2(
			$elm$parser$Parser$ignorer,
			A2(
				$elm$parser$Parser$ignorer,
				$elm$parser$Parser$succeed($author$project$Yaml$Object_),
				$elm$parser$Parser$symbol('{')),
			$author$project$Yaml$spaces),
		A2(
			$elm$parser$Parser$ignorer,
			A2(
				$elm$parser$Parser$ignorer,
				$author$project$Yaml$cyclic$flowObjectItems(),
				$author$project$Yaml$spaces),
			$elm$parser$Parser$symbol('}')));
}
function $author$project$Yaml$cyclic$flowObjectItems() {
	return $elm$parser$Parser$oneOf(
		_List_fromArray(
			[
				A2(
				...
				A2(
					...
					$elm$parser$Parser$lazy(
						function (_v4) {
							return $author$project$Yaml$cyclic$flowKeyValue();
						})),
				$author$project$Yaml$cyclic$flowObjectTail()),
				$elm$parser$Parser$succeed(_List_Nil)
			]));
}
function $author$project$Yaml$cyclic$flowObjectTail() {
	return $elm$parser$Parser$oneOf(
		_List_fromArray(
			[
				A2(
				...
				$elm$parser$Parser$lazy(
					function (_v3) {
						return $author$project$Yaml$cyclic$flowObjectTail();
					})),
				$elm$parser$Parser$succeed(_List_Nil)
			]));
}
function $author$project$Yaml$cyclic$flowValue() {
	return $elm$parser$Parser$oneOf(
		_List_fromArray(
			[
				$elm$parser$Parser$lazy(
				function (_v0) {
					return $author$project$Yaml$cyclic$flowList();
				}),
				$elm$parser$Parser$lazy(
				function (_v1) {
					return $author$project$Yaml$cyclic$flowObject();
				}),
				$author$project$Yaml$nullValue,
				$author$project$Yaml$boolValue,
				$author$project$Yaml$doubleQuotedString,
				$author$project$Yaml$singleQuotedString,
				$author$project$Yaml$numberValue,
				$author$project$Yaml$flowUnquotedString
			]));
}
try {
	var $author$project$Yaml$flowKeyValue = $author$project$Yaml$cyclic$flowKeyValue();
	$author$project$Yaml$cyclic$flowKeyValue = function () {
		return $author$project$Yaml$flowKeyValue;
	};
	var $author$project$Yaml$flowList = $author$project$Yaml$cyclic$flowList();
	$author$project$Yaml$cyclic$flowList = function () {
		return $author$project$Yaml$flowList;
	};
	var $author$project$Yaml$flowListItems = $author$project$Yaml$cyclic$flowListItems();
	$author$project$Yaml$cyclic$flowListItems = function () {
		return $author$project$Yaml$flowListItems;
	};
	var $author$project$Yaml$flowListTail = $author$project$Yaml$cyclic$flowListTail();
	$author$project$Yaml$cyclic$flowListTail = function () {
		return $author$project$Yaml$flowListTail;
	};
	var $author$project$Yaml$flowObject = $author$project$Yaml$cyclic$flowObject();
	$author$project$Yaml$cyclic$flowObject = function () {
		return $author$project$Yaml$flowObject;
	};
	var $author$project$Yaml$flowObjectItems = $author$project$Yaml$cyclic$flowObjectItems();
	$author$project$Yaml$cyclic$flowObjectItems = function () {
		return $author$project$Yaml$flowObjectItems;
	};
	var $author$project$Yaml$flowObjectTail = $author$project$Yaml$cyclic$flowObjectTail();
	$author$project$Yaml$cyclic$flowObjectTail = function () {
		return $author$project$Yaml$flowObjectTail;
	};
	var $author$project$Yaml$flowValue = $author$project$Yaml$cyclic$flowValue();
	$author$project$Yaml$cyclic$flowValue = function () {
		return $author$project$Yaml$flowValue;
	};
} catch ($) {
	throw 'Some top-level definitions from `Yaml` are causing infinite recursion:\n\n  ┌─────┐\n  │    flowKeyValue\n  │     ↓\n  │    flowList\n  │     ↓\n  │    flowListItems\n  │     ↓\n  │    flowListTail\n  │     ↓\n  │    flowObject\n  │     ↓\n  │    flowObjectItems\n  │     ↓\n  │    flowObjectTail\n  │     ↓\n  │    flowValue\n  └─────┘\n\nThese errors are very tricky, so read https://elm-lang.org/0.19.1/bad-recursion to learn how to fix it!';}
var $elm$core$String$trimLeft = _String_trimLeft;
var $author$project$Yaml$countLeadingSpaces = function (s) {
	return $elm$core$String$length(s) - $elm$core$String$length(
		$elm$core$String$trimLeft(s));
};
var $elm$core$Basics$ge = _Utils_ge;
var $author$project$Yaml$literalBlockHelper = F2(
				...
				[
					...
					function (line) {
						return $elm$core$String$isEmpty(
							$elm$core$String$trim(line)) ? $elm$parser$Parser$succeed(
							$elm$parser$Parser$Loop(
								_Utils_ap(
									lines,
									_List_fromArray(
										[''])))) : ((_Utils_cmp(
							$author$project$Yaml$countLeadingSpaces(line),
							indent) > -1) ? $elm$parser$Parser$succeed(
							$elm$parser$Parser$Loop(
								_Utils_ap(
									lines,
									_List_fromArray(
...
var $author$project$Yaml$foldedBlock = A2(
	$elm$parser$Parser$map,
	function (lines) {
		return $author$project$Yaml$String_(
			A2(
				$elm$core$String$join,
				' ',
				A2(
	...
	A2(
		...
		A2(
			$elm$parser$Parser$andThen,
			function (firstLine) {
				var blockIndent = $author$project$Yaml$countLeadingSpaces(firstLine);
				return A2(
					$elm$parser$Parser$loop,
					_List_fromArray(
						[
							$elm$core$String$trimLeft(firstLine)
						]),
					$author$project$Yaml$literalBlockHelper(blockIndent));
			},
			$elm$parser$Parser$getChompedString(
				$elm$parser$Parser$chompWhile(
					function (c) {
...
var $author$project$Yaml$inlineSpaces = $elm$parser$Parser$chompWhile(
	function (c) {
		return _Utils_eq(
			c,
			_Utils_chr(' ')) || _Utils_eq(
...
var $author$project$Yaml$optionalComment = $elm$parser$Parser$oneOf(
	_List_fromArray(
		[
			A2(
			$elm$parser$Parser$ignorer,
			A2(
				...
				A2(
					...
					$author$project$Yaml$inlineSpaces),
				$elm$parser$Parser$symbol('#')),
			$elm$parser$Parser$chompWhile(
				function (c) {
					return !_Utils_eq(
...
var $author$project$Yaml$isSpecialStart = function (c) {
	return _Utils_eq(
		c,
		_Utils_chr('{')) || (_Utils_eq(
		c,
...
var $author$project$Yaml$unquotedString = A2(
	$elm$parser$Parser$andThen,
	function (s) {
		var trimmed = $elm$core$String$trimRight(s);
		return $elm$core$String$isEmpty(trimmed) ? $elm$parser$Parser$problem('empty string') : $elm$parser$Parser$succeed(
			$author$project$Yaml$String_(trimmed));
	},
	$elm$parser$Parser$getChompedString(
		A2(
			...
			$elm$parser$Parser$chompIf(
				function (c) {
					return (!$author$project$Yaml$isSpecialStart(c)) && ((!_Utils_eq(
						c,
						_Utils_chr('\n'))) && (!_Utils_eq(
						c,
						_Utils_chr('\u000D'))));
...
var $author$project$Yaml$scalarValue = $elm$parser$Parser$oneOf(
	_List_fromArray(
		[$author$project$Yaml$nullValue, $author$project$Yaml$boolValue, $author$project$Yaml$doubleQuotedString, $author$project$Yaml$singleQuotedString, $author$project$Yaml$numberValue, $author$project$Yaml$unquotedString]));
var $author$project$Yaml$inlineValueThenNewline = A2(
	$elm$parser$Parser$keeper,
	$elm$parser$Parser$succeed($elm$core$Basics$identity),
	A2($elm$parser$Parser$ignorer, $author$project$Yaml$scalarValue, $author$project$Yaml$optionalComment));
var $elm$parser$Parser$Advanced$getOffset = $elm$parser$Parser$Advanced$Parser(
	function (s) {
		return A3($elm$parser$Parser$Advanced$Good, false, s.offset, s);
	});
var $elm$parser$Parser$getOffset = $elm$parser$Parser$Advanced$getOffset;
var $author$project$Yaml$literalBlock = A2(
	$elm$parser$Parser$map,
	function (lines) {
		return $author$project$Yaml$String_(
...
var $author$project$Yaml$mappingKey = $elm$parser$Parser$oneOf(
	_List_fromArray(
		[
			A2(
			$elm$parser$Parser$keeper,
...
var $author$project$Yaml$newlineAndSpaces = A2(
	$elm$parser$Parser$ignorer,
	A2(
		$elm$parser$Parser$ignorer,
		$elm$parser$Parser$succeed(_Utils_Tuple0),
...
var $author$project$Yaml$spacesNewlines = $elm$parser$Parser$chompWhile(
	function (c) {
		return _Utils_eq(
			c,
			_Utils_chr(' ')) || (_Utils_eq(
...
var $author$project$Yaml$blockList = function (indent) {
	return A2(
		$elm$parser$Parser$keeper,
		$elm$parser$Parser$succeed($author$project$Yaml$List_),
		A2(
			...
			function (first) {
				return A2(
					...
					_List_fromArray(
						[first]),
					$author$project$Yaml$blockListHelper(indent));
			},
			$author$project$Yaml$blockListItem(indent)));
};
var $author$project$Yaml$blockListHelper = F2(
			...
			_List_fromArray(
				[
					...
					A2(
						...
						$author$project$Yaml$spacesNewlines),
					$author$project$Yaml$blockListItem(indent)),
					A2(
					$elm$parser$Parser$map,
					function (_v8) {
...
var $author$project$Yaml$blockListItem = function (indent) {
	return A2(
		$elm$parser$Parser$keeper,
		A2(
			$elm$parser$Parser$ignorer,
			A2(
				$elm$parser$Parser$ignorer,
				$elm$parser$Parser$succeed($elm$core$Basics$identity),
				$author$project$Yaml$checkIndent(indent)),
			$elm$parser$Parser$symbol('- ')),
		$elm$parser$Parser$lazy(
			function (_v7) {
				return $author$project$Yaml$blockListItemValue(indent + 2);
			}));
};
var $author$project$Yaml$blockListItemValue = function (indent) {
	return $elm$parser$Parser$oneOf(
		_List_fromArray(
			[
				$author$project$Yaml$flowList,
				$author$project$Yaml$flowObject,
				$elm$parser$Parser$backtrackable(
				$elm$parser$Parser$lazy(
					function (_v5) {
						return $author$project$Yaml$blockMapping(indent);
					})),
				$elm$parser$Parser$lazy(
				function (_v6) {
					return $author$project$Yaml$blockList(indent);
				}),
				$author$project$Yaml$inlineValueThenNewline
			]));
};
var $author$project$Yaml$blockMapping = function (indent) {
	return A2(
		$elm$parser$Parser$keeper,
		$elm$parser$Parser$succeed($author$project$Yaml$Object_),
		A2(
			...
			function (first) {
				return A2(
					...
					_List_fromArray(
						[first]),
					$author$project$Yaml$blockMappingHelper(indent));
			},
			$author$project$Yaml$blockMappingPair(indent)));
};
var $author$project$Yaml$blockMappingHelper = F2(
				...
				[
					...
					A2(
						...
						$elm$parser$Parser$succeed(
							function (pair) {
								return $elm$parser$Parser$Loop(
									A2($elm$core$List$cons, pair, pairs));
							}),
						$author$project$Yaml$spacesNewlines),
					$author$project$Yaml$blockMappingPair(indent)),
					A2(
...
var $author$project$Yaml$blockMappingPair = function (indent) {
	return A2(
		$elm$parser$Parser$keeper,
		A2(
			$elm$parser$Parser$keeper,
			...
			A2(
				$elm$parser$Parser$ignorer,
				$author$project$Yaml$mappingKey,
				$elm$parser$Parser$symbol(':'))),
		$elm$parser$Parser$lazy(
			function (_v3) {
				return $author$project$Yaml$mappingValue(indent + 2);
			}));
};
var $author$project$Yaml$mappingValue = function (indent) {
	return $elm$parser$Parser$oneOf(
		_List_fromArray(
			[
				A2(
				...
				$elm$parser$Parser$oneOf(
					_List_fromArray(
						[$author$project$Yaml$flowList, $author$project$Yaml$flowObject, $author$project$Yaml$literalBlock, $author$project$Yaml$foldedBlock, $author$project$Yaml$inlineValueThenNewline]))),
				A2(
				$elm$parser$Parser$keeper,
				A2(
					$elm$parser$Parser$ignorer,
					A2(
						$elm$parser$Parser$ignorer,
						$elm$parser$Parser$succeed($elm$core$Basics$identity),
						$author$project$Yaml$optionalComment),
					$author$project$Yaml$newlineAndSpaces),
				$elm$parser$Parser$lazy(
					function (_v2) {
						return $author$project$Yaml$yamlValue(indent);
					}))
			]));
};
var $author$project$Yaml$yamlValue = function (indent) {
	return $elm$parser$Parser$oneOf(
		_List_fromArray(
			[
				$author$project$Yaml$flowList,
				$author$project$Yaml$flowObject,
				$author$project$Yaml$literalBlock,
				$author$project$Yaml$foldedBlock,
				$elm$parser$Parser$lazy(
				function (_v0) {
					return $author$project$Yaml$blockList(indent);
				}),
				...
				$author$project$Yaml$scalarValue
			]));
};
var $author$project$Yaml$yamlDocument = A2(
	$elm$parser$Parser$keeper,
	A2(
		$elm$parser$Parser$ignorer,
		$elm$parser$Parser$succeed($elm$core$Basics$identity),
	...
	A2(
		...
		$elm$parser$Parser$lazy(
			function (_v0) {
				return $author$project$Yaml$yamlValue(0);
			}),
		$author$project$Yaml$spaces));
var $author$project$Yaml$parse = function (input) {
	var trimmed = $elm$core$String$trim(input);
	if ($elm$core$String$isEmpty(trimmed)) {
		return $elm$core$Result$Ok($author$project$Yaml$Null_);
	} else {
		var _v0 = A2(
			$elm$parser$Parser$run,
			A2($elm$parser$Parser$ignorer, $author$project$Yaml$yamlDocument, $elm$parser$Parser$end),
			trimmed);
		if (_v0.$ === 'Ok') {
			var val = _v0.a;
			...
			var deadEnds = _v0.a;
			return $elm$core$Result$Err(
				$author$project$Yaml$deadEndsToString(deadEnds));
		}
	}
};
var $author$project$Frontmatter$extract = function (input) {
	if (A2($elm$core$String$startsWith, '---\n', input) || A2($elm$core$String$startsWith, '---\u000D\n', input)) {
		var afterOpening = A2($elm$core$String$startsWith, '---\u000D\n', input) ? A2($elm$core$String$dropLeft, 5, input) : A2($elm$core$String$dropLeft, 4, input);
		var closingIndex = $author$project$Frontmatter$findClosing(afterOpening);
		if (closingIndex.$ === 'Just') {
			var idx = closingIndex.a;
			var yamlBlock = A2($elm$core$String$left, idx, afterOpening);
			var rest = $author$project$Frontmatter$dropClosingLine(
				A2($elm$core$String$dropLeft, idx, afterOpening));
			var parsed = $author$project$Yaml$parse(yamlBlock);
			if (parsed.$ === 'Ok') {
				var value = parsed.a;
				return {
					body: rest,
					frontmatter: $elm$core$Maybe$Just(value)
				};
			} else {
				return {body: input, frontmatter: $elm$core$Maybe$Nothing};
			}
		} else {
			return {body: input, frontmatter: $elm$core$Maybe$Nothing};
		}
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$elm = A2(
	...
	$elm$core$Result$map($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$HCode));
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$syntaxToStyle = function (syntax) {
	switch (syntax.$) {
		case 'Number':
			return _Utils_Tuple2($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$Style1, 'go-n');
		case 'String':
			return _Utils_Tuple2($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$Style2, 'go-s');
		case 'Keyword':
			return _Utils_Tuple2($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$Style3, 'go-k');
		case 'DeclarationKeyword':
			return _Utils_Tuple2($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$Style3, 'go-dk');
		case 'Type':
			return _Utils_Tuple2($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$Style4, 'go-t');
		case 'Function':
			return _Utils_Tuple2($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$Style5, 'go-f');
		case 'LiteralKeyword':
			return _Utils_Tuple2($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$Style6, 'go-lk');
		case 'Package':
			return _Utils_Tuple2($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$Style3, 'go-p');
		case 'Operator':
			return _Utils_Tuple2($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$Style3, 'go-o');
		default:
			return _Utils_Tuple2($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$Style7, 'go-param');
	}
};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$groupCharSet = $elm$core$Set$fromList(
	_List_fromArray(
		[
			_Utils_chr('('),
			_Utils_chr(')'),
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$isGroupChar = function (c) {
	return A2($elm$core$Set$member, c, $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$groupCharSet);
};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$groupChar = A2(
	$elm$parser$Parser$map,
	function (s) {
		return _Utils_Tuple2($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Type$Normal, s);
	},
	$elm$parser$Parser$getChompedString(
		$elm$parser$Parser$chompIf($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$isGroupChar)));
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$isIdentifierNameChar = function (c) {
	return $elm$core$Char$isAlphaNum(c) || (_Utils_eq(
		c,
		_Utils_chr('_')) || ($elm$core$Char$toCode(c) > 127));
};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$DeclarationKeyword = {$: 'DeclarationKeyword'};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$Keyword = {$: 'Keyword'};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$LiteralKeyword = {$: 'LiteralKeyword'};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$Package = {$: 'Package'};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$Type = {$: 'Type'};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$Function = {$: 'Function'};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$Param = {$: 'Param'};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$types = $elm$core$Set$fromList(
	_List_fromArray(
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$isType = function (str) {
	return A2($elm$core$Set$member, str, $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$types);
};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$argParser = F2(
	function (revTokens, n) {
		return ($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$isType(n) || A2($elm$core$String$startsWith, '[]', n)) ? $elm$parser$Parser$succeed(
			A2(
				$elm$core$List$cons,
				_Utils_Tuple2(
					$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Type$C($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$Type),
					n),
				revTokens)) : $elm$parser$Parser$succeed(
			A2(
				$elm$core$List$cons,
				_Utils_Tuple2(
					$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Type$C($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$Param),
					n),
				revTokens));
	});
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$isCommentChar = function (c) {
	return _Utils_eq(
		c,
		_Utils_chr('/'));
};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$inlineComment = A2(
	$elm$parser$Parser$map,
	function (b) {
		return _List_fromArray(
			[
	...
	$elm$parser$Parser$getChompedString(
		A2(
			...
			A2($elm$core$Basics$composeL, $elm$core$Basics$not, $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Helpers$isLineBreak),
			$elm$parser$Parser$symbol('//'))));
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$lineBreakList = A2(
	$elm$parser$Parser$map,
	function (_v0) {
		return _List_fromArray(
			[
	...
	$elm$parser$Parser$symbol('\n'));
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$multilineComment = $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Helpers$delimited(
	{
		defaultMap: function (b) {
			return _Utils_Tuple2($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Type$Comment, b);
		},
		...
		innerParsers: _List_fromArray(
			[$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$lineBreakList]),
		isNestable: false,
		isNotRelevant: function (c) {
			return !$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Helpers$isLineBreak(c);
		},
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$comment = $elm$parser$Parser$oneOf(
	_List_fromArray(
		[$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$inlineComment, $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$multilineComment]));
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$whitespaceOrCommentStep = function (revTokens) {
	return $elm$parser$Parser$oneOf(
		_List_fromArray(
			[
				A2(
				...
				$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$comment)
			]));
};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$argLoop = function (revTokens) {
	return $elm$parser$Parser$oneOf(
		_List_fromArray(
			[
				$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$whitespaceOrCommentStep(revTokens),
				A2(
				$elm$parser$Parser$map,
				$elm$parser$Parser$Loop,
				A2(
					$elm$parser$Parser$andThen,
					$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$argParser(revTokens),
					$elm$parser$Parser$getChompedString(
						$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Helpers$chompIfThenWhile(
							function (c) {
								return !($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$isCommentChar(c) || ($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Helpers$isWhitespace(c) || (_Utils_eq(
									c,
									_Utils_chr(',')) || _Utils_eq(
									c,
									_Utils_chr(')')))));
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$functionDeclarationLoop = function (revTokens) {
	return $elm$parser$Parser$oneOf(
		_List_fromArray(
			[
				$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$whitespaceOrCommentStep(revTokens),
				...
				function (b) {
					return $elm$parser$Parser$Loop(
						A2(
							$elm$core$List$cons,
							_Utils_Tuple2(
								$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Type$C($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$Function),
								b),
							revTokens));
				},
				$elm$parser$Parser$getChompedString(
					$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Helpers$chompIfThenWhile($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$isIdentifierNameChar))),
				A2(
				$elm$parser$Parser$map,
				$elm$parser$Parser$Loop,
				A2(
					...
					function (_v0) {
						return A2(
							...
							A2(
								...
								_Utils_Tuple2($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Type$Normal, '('),
								revTokens),
							$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$argLoop);
					},
					$elm$parser$Parser$symbol('('))),
				$elm$parser$Parser$succeed(
				$elm$parser$Parser$Done(revTokens))
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$declarationKeywords = $elm$core$Set$fromList(
	_List_fromArray(
		['func', 'type', 'var', 'const', 'import']));
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$isDeclarationKeyword = function (str) {
	return A2($elm$core$Set$member, str, $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$declarationKeywords);
};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$keywords = $elm$core$Set$fromList(
	_List_fromArray(
		['break', 'case', 'chan', 'continue', 'default', 'defer', 'else', 'fallthrough', 'for', 'go', 'goto', 'if', 'interface', 'map', 'range', 'return', 'select', 'struct', 'switch']));
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$isKeyword = function (str) {
	return A2($elm$core$Set$member, str, $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$keywords);
};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$literalKeywordSet = $elm$core$Set$fromList(
	_List_fromArray(
		['true', 'false', 'nil']));
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$isLiteralKeyword = function (str) {
	return A2($elm$core$Set$member, str, $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$literalKeywordSet);
};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$isPackage = function (str) {
	return str === 'package';
};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$keywordParser = F2(
	function (revTokens, n) {
		return (n === 'func') ? A2(
			$elm$parser$Parser$loop,
			A2(
				$elm$core$List$cons,
				_Utils_Tuple2(
					$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Type$C($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$DeclarationKeyword),
					n),
				revTokens),
			$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$functionDeclarationLoop) : ($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$isType(n) ? $elm$parser$Parser$succeed(
			A2(
				$elm$core$List$cons,
				_Utils_Tuple2(
					$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Type$C($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$Type),
					n),
				revTokens)) : ($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$isPackage(n) ? $elm$parser$Parser$succeed(
			A2(
				$elm$core$List$cons,
				_Utils_Tuple2(
					$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Type$C($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$Package),
					n),
				revTokens)) : ($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$isKeyword(n) ? $elm$parser$Parser$succeed(
			A2(
				$elm$core$List$cons,
				_Utils_Tuple2(
					$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Type$C($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$Keyword),
					n),
				revTokens)) : ($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$isDeclarationKeyword(n) ? $elm$parser$Parser$succeed(
			A2(
				$elm$core$List$cons,
				_Utils_Tuple2(
					$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Type$C($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$DeclarationKeyword),
					n),
				revTokens)) : ($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$isLiteralKeyword(n) ? $elm$parser$Parser$succeed(
			A2(
				$elm$core$List$cons,
				_Utils_Tuple2(
					$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Type$C($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$LiteralKeyword),
					n),
				revTokens)) : $elm$parser$Parser$succeed(
			A2(
				$elm$core$List$cons,
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$Number = {$: 'Number'};
var $elm$core$Char$isHexDigit = function (_char) {
	var code = $elm$core$Char$toCode(_char);
	return ((48 <= code) && (code <= 57)) || (((65 <= code) && (code <= 70)) || ((97 <= code) && (code <= 102)));
};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$hexNumber = A2(
	$elm$parser$Parser$ignorer,
	A2(
		$elm$parser$Parser$ignorer,
		$elm$parser$Parser$succeed(_Utils_Tuple0),
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$number = A2(
	$elm$parser$Parser$map,
	function (b) {
		return _Utils_Tuple2(
			$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Type$C($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$Number),
			b);
	},
	$elm$parser$Parser$getChompedString(
		$elm$parser$Parser$oneOf(
			_List_fromArray(
				[$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$hexNumber, $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Helpers$number, $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Helpers$numberExponentialNotation]))));
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$Operator = {$: 'Operator'};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$operatorSet = $elm$core$Set$fromList(
	_List_fromArray(
		[
			_Utils_chr('+'),
			_Utils_chr('-'),
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$isOperator = function (c) {
	return A2($elm$core$Set$member, c, $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$operatorSet);
};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$operatorChar = A2(
	$elm$parser$Parser$map,
	function (s) {
		return _Utils_Tuple2(
			$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Type$C($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$Operator),
			s);
	},
	$elm$parser$Parser$getChompedString(
		$elm$parser$Parser$chompIf($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$isOperator)));
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$String = {$: 'String'};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$doubleQuoteString = function () {
	var delimiter = {
		defaultMap: function (b) {
			return _Utils_Tuple2(
				$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Type$C($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$String),
				b);
		},
		end: '\"',
		innerParsers: _List_Nil,
		isNestable: false,
		isNotRelevant: function (c) {
			return !_Utils_eq(
				c,
	...
	return $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Helpers$delimited(delimiter);
}();
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$rawString = function () {
	var delimiter = {
		defaultMap: function (b) {
			return _Utils_Tuple2(
				$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Type$C($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$String),
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$singleQuoteString = function () {
	var delimiter = {
		defaultMap: function (b) {
			return _Utils_Tuple2(
				$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Type$C($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$String),
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$stringLiteral = $elm$parser$Parser$oneOf(
	_List_fromArray(
		[$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$rawString, $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$doubleQuoteString, $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$singleQuoteString]));
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$mainLoop = function (revTokens) {
	return $elm$parser$Parser$oneOf(
		_List_fromArray(
			[
				$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$whitespaceOrCommentStep(revTokens),
				...
				$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$stringLiteral),
				A2(
				$elm$parser$Parser$map,
				function (s) {
					return $elm$parser$Parser$Loop(
				...
				$elm$parser$Parser$oneOf(
					_List_fromArray(
						[$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$operatorChar, $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$groupChar, $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$number]))),
				A2(
				$elm$parser$Parser$map,
				$elm$parser$Parser$Loop,
				A2(
					$elm$parser$Parser$andThen,
					$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$keywordParser(revTokens),
					$elm$parser$Parser$getChompedString(
						$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Helpers$chompIfThenWhile($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$isIdentifierNameChar)))),
				A2(
				$elm$parser$Parser$map,
				...
				A2(
					...
					function (str) {
						return $elm$parser$Parser$succeed(
							A2(
								$elm$core$List$cons,
								_Utils_Tuple2($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Type$Normal, str),
								revTokens));
					},
					$elm$parser$Parser$getChompedString(
						$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Helpers$chompIfThenWhile(
							A2($elm$core$Basics$composeR, $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Helpers$isLineBreak, $elm$core$Basics$not))))),
				$elm$parser$Parser$succeed(
				$elm$parser$Parser$Done(revTokens))
			]));
};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$toRevTokens = A2($elm$parser$Parser$loop, _List_Nil, $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$mainLoop);
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$toLines = A2(
	$elm$core$Basics$composeR,
	$elm$parser$Parser$run($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$toRevTokens),
	$elm$core$Result$map(
		$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Line$Helpers$toLines($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$syntaxToStyle)));
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$go = A2(
	$elm$core$Basics$composeR,
	$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Go$toLines,
	$elm$core$Result$map($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$HCode));
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$json = A2(
	...
	$elm$core$Result$map($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$HCode));
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$syntaxToStyle = function (syntax) {
	switch (syntax.$) {
		case 'Number':
			return _Utils_Tuple2($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$Style1, 'kt-n');
		case 'String':
			return _Utils_Tuple2($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$Style2, 'kt-s');
		case 'DeclarationKeyword':
			return _Utils_Tuple2($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$Style3, 'kt-dk');
		case 'Keyword':
			return _Utils_Tuple2($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$Style3, 'kt-k');
		case 'Operator':
			return _Utils_Tuple2($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$Style4, 'kt-o');
		case 'Function':
			return _Utils_Tuple2($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$Style5, 'kt-f');
		case 'Punctuation':
			return _Utils_Tuple2($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$Style6, 'kt-pu');
		case 'Literal':
			return _Utils_Tuple2($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$Style7, 'kt-l');
		default:
			return _Utils_Tuple2($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$Style7, 'kt-pa');
	}
};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$inlineComment = $elm$parser$Parser$oneOf(
	A2(
		$elm$core$List$map,
		A2(
			$elm$core$Basics$composeR,
		...
		_List_fromArray(
			['//'])));
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$lineBreakList = A2(
	$elm$parser$Parser$map,
	function (_v0) {
		return _List_fromArray(
			[
	...
	$elm$parser$Parser$symbol('\n'));
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$multilineComment = $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Helpers$delimited(
	{
		defaultMap: function (b) {
			return _Utils_Tuple2($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Type$Comment, b);
		},
		...
		innerParsers: _List_fromArray(
			[$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$lineBreakList]),
		isNestable: false,
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$comment = $elm$parser$Parser$oneOf(
	_List_fromArray(
		[$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$inlineComment, $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$multilineComment]));
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$punctuatorSet = $elm$core$Set$fromList(
	_List_fromArray(
		[
			_Utils_chr('{'),
			_Utils_chr('}'),
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$isPunctuationChar = function (c) {
	return A2($elm$core$Set$member, c, $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$punctuatorSet);
};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$isIdentifierChar = function (c) {
	return !($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Helpers$isWhitespace(c) || $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$isPunctuationChar(c));
};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$DeclarationKeyword = {$: 'DeclarationKeyword'};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$Keyword = {$: 'Keyword'};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$Literal = {$: 'Literal'};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$Operator = {$: 'Operator'};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$Function = {$: 'Function'};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$isCommentChar = function (c) {
	return _Utils_eq(
		c,
		_Utils_chr('/'));
};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$isStringLiteralChar = function (c) {
	return _Utils_eq(
		c,
		_Utils_chr('\'')) || _Utils_eq(
		c,
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$isIdentifierNameChar = function (c) {
	return !($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$isPunctuationChar(c) || ($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$isStringLiteralChar(c) || ($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$isCommentChar(c) || $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Helpers$isWhitespace(c))));
};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$lineBreak = A2(
	$elm$parser$Parser$map,
	function (_v0) {
		return _Utils_Tuple2($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Type$LineBreak, '\n');
	},
	$elm$parser$Parser$symbol('\n'));
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$space = A2(
	$elm$parser$Parser$map,
	function (b) {
		return _Utils_Tuple2($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Type$Normal, b);
	},
	$elm$parser$Parser$getChompedString(
		$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Helpers$chompIfThenWhile($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Helpers$isSpace)));
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$checkContext = function (revTokens) {
	return $elm$parser$Parser$oneOf(
		_List_fromArray(
			[
				$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$whitespaceOrCommentStep(revTokens),
				$elm$parser$Parser$succeed(
				$elm$parser$Parser$Done(revTokens))
			]));
};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$whitespaceOrCommentStep = function (revTokens) {
	return $elm$parser$Parser$oneOf(
		_List_fromArray(
			[
				A2(
				...
				$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$space),
				A2(
				$elm$parser$Parser$andThen,
				$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$checkContext,
				A2(
					$elm$parser$Parser$map,
					function (s) {
						return A2($elm$core$List$cons, s, revTokens);
					},
					$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$lineBreak)),
				A2(
				$elm$parser$Parser$map,
				function (s) {
					return $elm$parser$Parser$Loop(
				...
				$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$comment)
			]));
};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$functionDeclarationLoop = function (revTokens) {
	return $elm$parser$Parser$oneOf(
		_List_fromArray(
			[
				$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$whitespaceOrCommentStep(revTokens),
				...
				function (b) {
					return $elm$parser$Parser$Loop(
						A2(
							$elm$core$List$cons,
							_Utils_Tuple2(
								$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Type$C($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$Function),
								b),
							revTokens));
				},
				$elm$parser$Parser$getChompedString(
					$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Helpers$chompIfThenWhile($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$isIdentifierNameChar))),
				A2(
				$elm$parser$Parser$map,
				function (_v0) {
					return $elm$parser$Parser$Loop(
						A2(
							$elm$core$List$cons,
							_Utils_Tuple2(
								$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Type$C($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$Keyword),
								'*'),
							revTokens));
				},
				$elm$parser$Parser$symbol('*')),
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$declarationKeywordSet = $elm$core$Set$fromList(
	_List_fromArray(
		['var', 'val', 'vararg']));
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$isDeclarationKeyword = function (str) {
	return A2($elm$core$Set$member, str, $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$declarationKeywordSet);
};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$isFunction = $elm$core$Basics$eq('fun');
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$keywordPattern = A2(
	$elm$core$Maybe$withDefault,
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$isKeyword = $elm$regex$Regex$contains($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$keywordPattern);
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$literalSet = $elm$core$Set$fromList(
	_List_fromArray(
		['false', 'true', 'null']));
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$isLiteral = function (str) {
	return A2($elm$core$Set$member, str, $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$literalSet);
};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$operatorPattern = A2(
	$elm$core$Maybe$withDefault,
	$elm$regex$Regex$never,
	A2(
		$elm$regex$Regex$fromStringWith,
		{caseInsensitive: false, multiline: false},
		'^([=!<>\\+]=?|\\+|\\|\\||&&|as\\??|!?in|!?is)$'));
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$isOperator = $elm$regex$Regex$contains($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$operatorPattern);
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$keywordParser = F2(
	function (revTokens, s) {
		return $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$isOperator(s) ? $elm$parser$Parser$succeed(
			A2(
				$elm$core$List$cons,
				_Utils_Tuple2(
					$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Type$C($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$Operator),
					s),
				revTokens)) : ($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$isFunction(s) ? A2(
			$elm$parser$Parser$loop,
			A2(
				$elm$core$List$cons,
				_Utils_Tuple2(
					$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Type$C($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$DeclarationKeyword),
					s),
				revTokens),
			$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$functionDeclarationLoop) : ($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$isKeyword(s) ? $elm$parser$Parser$succeed(
			A2(
				$elm$core$List$cons,
				_Utils_Tuple2(
					$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Type$C($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$Keyword),
					s),
				revTokens)) : ($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$isLiteral(s) ? $elm$parser$Parser$succeed(
			A2(
				$elm$core$List$cons,
				_Utils_Tuple2(
					$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Type$C($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$Literal),
					s),
				revTokens)) : ($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$isDeclarationKeyword(s) ? $elm$parser$Parser$succeed(
			A2(
				$elm$core$List$cons,
				_Utils_Tuple2(
					$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Type$C($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$DeclarationKeyword),
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$Number = {$: 'Number'};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$hexNumber = A2(
	$elm$parser$Parser$ignorer,
	A2(
		$elm$parser$Parser$ignorer,
		$elm$parser$Parser$succeed(_Utils_Tuple0),
		$elm$parser$Parser$backtrackable(
			$elm$parser$Parser$symbol('0x'))),
	$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Helpers$chompIfThenWhile($elm$core$Char$isHexDigit));
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$number = A2(
	$elm$parser$Parser$map,
	function (b) {
		return _Utils_Tuple2(
			$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Type$C($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$Number),
			b);
	},
	$elm$parser$Parser$getChompedString(
		$elm$parser$Parser$oneOf(
			_List_fromArray(
				[$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$hexNumber, $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Helpers$number]))));
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$Punctuation = {$: 'Punctuation'};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$punctuationChar = A2(
	$elm$parser$Parser$map,
	function (b) {
		return _Utils_Tuple2(
			$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Type$C($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$Punctuation),
			b);
	},
	$elm$parser$Parser$getChompedString(
		$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Helpers$chompIfThenWhile($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$isPunctuationChar)));
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$String = {$: 'String'};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$ktEscapable = A2(
	$elm$parser$Parser$map,
	function (b) {
		return _List_fromArray(
			[
	...
	$elm$parser$Parser$getChompedString($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Helpers$escapable));
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$quoteDelimiter = {
	defaultMap: function (b) {
		return _Utils_Tuple2(
			$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Type$C($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$String),
			b);
	},
	end: '\'',
	innerParsers: _List_fromArray(
		[$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$lineBreakList, $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$ktEscapable]),
	isNestable: false,
	isNotRelevant: function (c) {
		return !($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Helpers$isLineBreak(c) || $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Helpers$isEscapable(c));
	},
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$doubleQuote = $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Helpers$delimited(
	_Utils_update(
		$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$quoteDelimiter,
		{end: '\"', start: '\"'}));
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$multilineString = $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Helpers$delimited(
	_Utils_update(
		$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$quoteDelimiter,
		{end: '\"\"\"', start: '\"\"\"'}));
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$quote = $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Helpers$delimited($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$quoteDelimiter);
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$stringLiteral = $elm$parser$Parser$oneOf(
	_List_fromArray(
		[$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$multilineString, $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$quote, $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$doubleQuote]));
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$stringBody = function (revTokens) {
	return $elm$parser$Parser$oneOf(
		_List_fromArray(
			[
				$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$whitespaceOrCommentStep(revTokens),
				...
				$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$stringLiteral),
				$elm$parser$Parser$succeed(
				$elm$parser$Parser$Done(revTokens))
			]));
};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$mainLoop = function (revTokens) {
	return $elm$parser$Parser$oneOf(
		_List_fromArray(
			[
				A2(
				...
				$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$punctuationChar),
				A2(
				$elm$parser$Parser$map,
				function (n) {
					return $elm$parser$Parser$Loop(
				...
				$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$number),
				A2(
				$elm$parser$Parser$map,
				function (n) {
					return $elm$parser$Parser$Loop(
				...
				A2(
					...
					function (n) {
						return A2(
							$elm$parser$Parser$loop,
							_Utils_ap(n, revTokens),
							$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$stringBody);
					},
					$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$stringLiteral)),
				A2(
				$elm$parser$Parser$map,
				...
				A2(
					$elm$parser$Parser$andThen,
					$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$keywordParser(revTokens),
					$elm$parser$Parser$getChompedString(
						$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Helpers$chompIfThenWhile($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$isIdentifierChar)))),
				$elm$parser$Parser$succeed(
				$elm$parser$Parser$Done(revTokens))
			]));
};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$toRevTokens = A2($elm$parser$Parser$loop, _List_Nil, $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$mainLoop);
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$toLines = A2(
	$elm$core$Basics$composeR,
	$elm$parser$Parser$run($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$toRevTokens),
	$elm$core$Result$map(
		$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Line$Helpers$toLines($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$syntaxToStyle)));
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$kotlin = A2(
	$elm$core$Basics$composeR,
	$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Kotlin$toLines,
	$elm$core$Result$map($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$HCode));
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$inlineComment = $elm$parser$Parser$oneOf(
	A2(
		$elm$core$List$map,
		A2(
			$elm$core$Basics$composeR,
		...
		_List_fromArray(
			['#'])));
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$lineBreakList = A2(
	$elm$parser$Parser$map,
	function (_v0) {
		return _List_fromArray(
			[
	...
	$elm$parser$Parser$symbol('\n'));
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$multilineComment = $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Helpers$delimited(
	{
		defaultMap: function (b) {
			return _Utils_Tuple2($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Type$Comment, b);
		},
		...
		innerParsers: _List_fromArray(
			[$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$lineBreakList]),
		isNestable: false,
		isNotRelevant: A2($elm$core$Basics$composeL, $elm$core$Basics$not, $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Helpers$isLineBreak),
		start: '/*'
	});
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$comment = $elm$parser$Parser$oneOf(
	_List_fromArray(
		[$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$inlineComment, $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$multilineComment]));
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$punctuatorSet = $elm$core$Set$fromList(
	_List_fromArray(
		[
			_Utils_chr('{'),
			_Utils_chr('}'),
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$isPunctuationChar = function (c) {
	return A2($elm$core$Set$member, c, $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$punctuatorSet);
};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$isIdentifierChar = function (c) {
	return !($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Helpers$isWhitespace(c) || $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$isPunctuationChar(c));
};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$Function = {$: 'Function'};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$Keyword = {$: 'Keyword'};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$Literal = {$: 'Literal'};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$Operator = {$: 'Operator'};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$functionPattern = A2(
	$elm$core$Maybe$withDefault,
	$elm$regex$Regex$never,
	A2(
		$elm$regex$Regex$fromStringWith,
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$isFunction = $elm$regex$Regex$contains($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$functionPattern);
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$keywordPattern = A2(
	$elm$core$Maybe$withDefault,
	$elm$regex$Regex$never,
	A2(
		$elm$regex$Regex$fromStringWith,
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$isKeyword = $elm$regex$Regex$contains($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$keywordPattern);
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$literalSet = $elm$core$Set$fromList(
	_List_fromArray(
		['false', 'true']));
var $elm$core$String$toUpper = _String_toUpper;
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$isLiteral = function (str) {
	return A2(
		$elm$core$Set$member,
		$elm$core$String$toUpper(str),
		$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$literalSet);
};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$operatorPattern = A2(
	$elm$core$Maybe$withDefault,
	$elm$regex$Regex$never,
	A2(
		$elm$regex$Regex$fromStringWith,
		{caseInsensitive: false, multiline: false},
		'^([=!<>]=?|\\+\\+?|\\|\\||&&|\\/\\/|->?|[?@])$'));
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$isOperator = $elm$regex$Regex$contains($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$operatorPattern);
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$keywordParser = F2(
	function (revTokens, s) {
		return $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$isOperator(s) ? $elm$parser$Parser$succeed(
			A2(
				$elm$core$List$cons,
				_Utils_Tuple2(
					$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Type$C($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$Operator),
					s),
				revTokens)) : ($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$isFunction(s) ? $elm$parser$Parser$succeed(
			A2(
				$elm$core$List$cons,
				_Utils_Tuple2(
					$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Type$C($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$Function),
					s),
				revTokens)) : ($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$isKeyword(s) ? $elm$parser$Parser$succeed(
			A2(
				$elm$core$List$cons,
				_Utils_Tuple2(
					$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Type$C($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$Keyword),
					s),
				revTokens)) : ($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$isLiteral(s) ? $elm$parser$Parser$succeed(
			A2(
				$elm$core$List$cons,
				_Utils_Tuple2(
					$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Type$C($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$Literal),
					s),
				revTokens)) : $elm$parser$Parser$succeed(
			A2(
				$elm$core$List$cons,
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$lineBreak = A2(
	$elm$parser$Parser$map,
	function (_v0) {
		return _Utils_Tuple2($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Type$LineBreak, '\n');
	},
	$elm$parser$Parser$symbol('\n'));
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$Number = {$: 'Number'};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$hexNumber = A2(
	$elm$parser$Parser$ignorer,
	A2(
		$elm$parser$Parser$ignorer,
		$elm$parser$Parser$succeed(_Utils_Tuple0),
		$elm$parser$Parser$backtrackable(
			$elm$parser$Parser$symbol('0x'))),
	$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Helpers$chompIfThenWhile($elm$core$Char$isHexDigit));
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$number = A2(
	$elm$parser$Parser$map,
	function (b) {
		return _Utils_Tuple2(
			$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Type$C($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$Number),
			b);
	},
	$elm$parser$Parser$getChompedString(
		$elm$parser$Parser$oneOf(
			_List_fromArray(
				[$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$hexNumber, $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Helpers$number]))));
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$Punctuation = {$: 'Punctuation'};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$punctuationChar = A2(
	$elm$parser$Parser$map,
	function (b) {
		return _Utils_Tuple2(
			$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Type$C($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$Punctuation),
			b);
	},
	$elm$parser$Parser$getChompedString(
		$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Helpers$chompIfThenWhile($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$isPunctuationChar)));
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$space = A2(
	$elm$parser$Parser$map,
	function (b) {
		return _Utils_Tuple2($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Type$Normal, b);
	},
	$elm$parser$Parser$getChompedString(
		$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Helpers$chompIfThenWhile($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Helpers$isSpace)));
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$String = {$: 'String'};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$nixEscapable = A2(
	$elm$parser$Parser$map,
	function (b) {
		return _List_fromArray(
			[
	...
	$elm$parser$Parser$getChompedString($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Helpers$escapable));
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$quoteDelimiter = {
	defaultMap: function (b) {
		return _Utils_Tuple2(
			$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Type$C($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$String),
			b);
	},
	end: '\'',
	innerParsers: _List_fromArray(
		[$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$lineBreakList, $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$nixEscapable]),
	isNestable: false,
	isNotRelevant: function (c) {
		return !($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Helpers$isLineBreak(c) || $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Helpers$isEscapable(c));
	},
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$doubleQuote = $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Helpers$delimited(
	_Utils_update(
		$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$quoteDelimiter,
		{end: '\"', start: '\"'}));
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$multilineString = $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Helpers$delimited(
	_Utils_update(
		$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$quoteDelimiter,
		{end: '\'\'', start: '\'\''}));
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$quote = $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Helpers$delimited($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$quoteDelimiter);
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$stringLiteral = $elm$parser$Parser$oneOf(
	_List_fromArray(
		[$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$multilineString, $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$quote, $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$doubleQuote]));
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$checkContext = function (revTokens) {
	return $elm$parser$Parser$oneOf(
		_List_fromArray(
			[
				$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$whitespaceOrCommentStep(revTokens),
				$elm$parser$Parser$succeed(
				$elm$parser$Parser$Done(revTokens))
			]));
};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$whitespaceOrCommentStep = function (revTokens) {
	return $elm$parser$Parser$oneOf(
		_List_fromArray(
			[
				A2(
				...
				$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$space),
				A2(
				$elm$parser$Parser$andThen,
				$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$checkContext,
				A2(
					$elm$parser$Parser$map,
					function (s) {
						return A2($elm$core$List$cons, s, revTokens);
					},
					$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$lineBreak)),
				A2(
				$elm$parser$Parser$map,
				function (s) {
					return $elm$parser$Parser$Loop(
				...
				$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$comment)
			]));
};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$stringBody = function (revTokens) {
	return $elm$parser$Parser$oneOf(
		_List_fromArray(
			[
				$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$whitespaceOrCommentStep(revTokens),
				...
				$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$stringLiteral),
				$elm$parser$Parser$succeed(
				$elm$parser$Parser$Done(revTokens))
			]));
};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$mainLoop = function (revTokens) {
	return $elm$parser$Parser$oneOf(
		_List_fromArray(
			[
				A2(
				...
				$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$punctuationChar),
				A2(
				$elm$parser$Parser$map,
				function (n) {
					return $elm$parser$Parser$Loop(
				...
				$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$number),
				A2(
				$elm$parser$Parser$map,
				function (n) {
					return $elm$parser$Parser$Loop(
				...
				A2(
					...
					function (n) {
						return A2(
							$elm$parser$Parser$loop,
							_Utils_ap(n, revTokens),
							$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$stringBody);
					},
					$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$stringLiteral)),
				A2(
				$elm$parser$Parser$map,
				...
				A2(
					$elm$parser$Parser$andThen,
					$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$keywordParser(revTokens),
					$elm$parser$Parser$getChompedString(
						$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Helpers$chompIfThenWhile($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$isIdentifierChar)))),
				$elm$parser$Parser$succeed(
				$elm$parser$Parser$Done(revTokens))
			]));
};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$toRevTokens = A2($elm$parser$Parser$loop, _List_Nil, $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$mainLoop);
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$toLines = A2(
	$elm$core$Basics$composeR,
	$elm$parser$Parser$run($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$toRevTokens),
	$elm$core$Result$map(
		$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Line$Helpers$toLines($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$syntaxToStyle)));
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$nix = A2(
	$elm$core$Basics$composeR,
	$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Nix$toLines,
	$elm$core$Result$map($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$HCode));
var $elm$html$Html$pre = _VirtualDom_node('pre');
var $elm$virtual_dom$VirtualDom$text = _VirtualDom_text;
var $elm$html$Html$text = $elm$virtual_dom$VirtualDom$text;
var $author$project$Markdown$plainCodeBlock = F2(
	function (language, body) {
		...
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('md-code-block')
				]),
			_List_fromArray(
				[
					A2(
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$xml = A2(
	...
	$elm$core$Result$map($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$HCode));
var $author$project$Markdown$renderCodeBlock = function (_v0) {
	var body = _v0.body;
	var language = _v0.language;
	var highlighter = function () {
		var _v3 = A2($elm$core$Maybe$map, $elm$core$String$toLower, language);
		_v3$13:
		while (true) {
			if (_v3.$ === 'Just') {
				switch (_v3.a) {
					case 'elm':
						return $elm$core$Maybe$Just($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$elm);
					case 'javascript':
						return $elm$core$Maybe$Just($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$javascript);
					case 'js':
						return $elm$core$Maybe$Just($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$javascript);
					case 'python':
						return $elm$core$Maybe$Just($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$python);
					case 'py':
						return $elm$core$Maybe$Just($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$python);
					case 'css':
						return $elm$core$Maybe$Just($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$css);
					case 'json':
						return $elm$core$Maybe$Just($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$json);
					case 'sql':
						return $elm$core$Maybe$Just($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$sql);
					case 'xml':
						return $elm$core$Maybe$Just($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$xml);
					case 'html':
						return $elm$core$Maybe$Just($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$xml);
					case 'go':
						return $elm$core$Maybe$Just($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$go);
					case 'kotlin':
						return $elm$core$Maybe$Just($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$kotlin);
					case 'nix':
						return $elm$core$Maybe$Just($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$nix);
					default:
						break _v3$13;
				}
			} else {
	...
	if (highlighter.$ === 'Just') {
		var highlight = highlighter.a;
		var _v2 = highlight(body);
		if (_v2.$ === 'Ok') {
			var hcode = _v2.a;
			return A2(
				$elm$html$Html$div,
				...
				_List_fromArray(
					[
						A2($pablohirafuji$elm_syntax_highlight$SyntaxHighlight$toBlockHtml, $elm$core$Maybe$Nothing, hcode)
					]));
		} else {
			return A2($author$project$Markdown$plainCodeBlock, language, body);
		}
	} else {
		return A2($author$project$Markdown$plainCodeBlock, language, body);
	}
...
var $author$project$Markdown$renderHeading = function (_v0) {
	var level = _v0.level;
...
var $author$project$Markdown$renderImage = function (imageInfo) {
	var _v0 = imageInfo.title;
	if (_v0.$ === 'Just') {
		var title_ = _v0.a;
		return A2(
			$elm$html$Html$img,
...
var $author$project$Markdown$renderOrderedList = F2(
	function (startIndex, items) {
		return A2(
			$elm$html$Html$ol,
			(startIndex !== 1) ? _List_fromArray(
				[
					$elm$html$Html$Attributes$start(startIndex)
				]) : _List_Nil,
			A2(
				$elm$core$List$map,
				function (itemBlocks) {
...
var $author$project$Markdown$renderTableCell = F3(
	function (element, maybeAlignment, children) {
		var attrs = function () {
			if (maybeAlignment.$ === 'Just') {
				switch (maybeAlignment.a.$) {
					case 'AlignLeft':
						var _v1 = maybeAlignment.a;
						return _List_fromArray(
							[
								A2($elm$html$Html$Attributes$style, 'text-align', 'left')
							]);
					case 'AlignCenter':
						var _v2 = maybeAlignment.a;
						return _List_fromArray(
							[
								A2($elm$html$Html$Attributes$style, 'text-align', 'center')
							]);
					default:
						var _v3 = maybeAlignment.a;
						return _List_fromArray(
							[
		...
		return A2(element, attrs, children);
	});
...
var $author$project$Markdown$renderUnorderedList = function (items) {
	return A2(
		$elm$html$Html$ul,
		_List_Nil,
		A2(
			...
			function (_v0) {
				...
				var taskClass = function () {
					if (task.$ === 'NoTask') {
						...
						return _List_fromArray(
							[
								$elm$html$Html$Attributes$class('md-task-item')
							]);
					}
				}();
							...
							return A2(
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Attributes$class('md-task-checkbox')
									]),
								_List_Nil);
						default:
							return A2(
...
var $author$project$Markdown$customRenderer = {
	blockQuote: $elm$html$Html$blockquote(
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('md-blockquote')
			])),
	codeBlock: $author$project$Markdown$renderCodeBlock,
	codeSpan: function (content) {
		return A2(
			$elm$html$Html$code,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('md-code-span')
				]),
			_List_fromArray(
				[
	...
	heading: $author$project$Markdown$renderHeading,
	html: $dillonkearns$elm_markdown$Markdown$Html$oneOf(_List_Nil),
	image: $author$project$Markdown$renderImage,
	link: $author$project$Markdown$renderLink,
	orderedList: $author$project$Markdown$renderOrderedList,
	...
	table: $elm$html$Html$table(
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('md-table')
			])),
	tableBody: $elm$html$Html$tbody(_List_Nil),
	tableCell: $author$project$Markdown$renderTableCell($elm$html$Html$td),
	tableHeader: $elm$html$Html$thead(_List_Nil),
	tableHeaderCell: $author$project$Markdown$renderTableCell($elm$html$Html$th),
	...
	thematicBreak: A2(
		...
		_List_Nil),
	unorderedList: $author$project$Markdown$renderUnorderedList
};
...
var $author$project$Markdown$renderMarkdown = function (input) {
	var _v0 = A2(
		$elm$core$Result$andThen,
		$dillonkearns$elm_markdown$Markdown$Renderer$render($author$project$Markdown$customRenderer),
		A2(
			$elm$core$Result$mapError,
			function (_v1) {
				return 'Parse error';
...
var $author$project$Markdown$parse = function (input) {
	var _v0 = $author$project$Frontmatter$extract(input);
	var frontmatter = _v0.frontmatter;
	var body = _v0.body;
	var html = $author$project$Markdown$renderMarkdown(body);
	return {frontmatter: frontmatter, html: html};
};
var $author$project$Ports$toElectron = _Platform_outgoingPort('toElectron', $elm$core$Basics$identity);
var $author$project$Main$saveFile = function (model) {
	var _v0 = model.editor.filePath;
	if (_v0.$ === 'Just') {
		var path = _v0.a;
		return _Utils_Tuple2(
			model,
			$author$project$Ports$toElectron(
				$elm$json$Json$Encode$object(
					_List_fromArray(
						[
							_Utils_Tuple2(
							'tag',
							$elm$json$Json$Encode$string('writeFile')),
							_Utils_Tuple2(
							'path',
							$elm$json$Json$Encode$string(path)),
							_Utils_Tuple2(
							'content',
							$elm$json$Json$Encode$string(model.editor.content))
						]))));
	} else {
		return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
	}
};
var $author$project$Editor$setContent = F3(
	function (path, content, model) {
		return _Utils_update(
			model,
			{
				content: content,
				dirtyState: $author$project$Types$Clean,
				filePath: $elm$core$Maybe$Just(path),
				scrollTop: 0
			});
	});
var $author$project$Main$setDirtyCmd = function (dirty) {
	return $author$project$Ports$toElectron(
		$elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'tag',
					$elm$json$Json$Encode$string('setDirty')),
					_Utils_Tuple2(
					'dirty',
					$elm$json$Json$Encode$bool(dirty))
				])));
};
var $author$project$Types$Dirty = {$: 'Dirty'};
...
var $author$project$Main$setTitleCmd = function (editor) {
	var title = function () {
		var _v0 = editor.filePath;
		if (_v0.$ === 'Just') {
			var path = _v0.a;
			return 'Fence — ' + ($author$project$Main$baseName(path) + (_Utils_eq(editor.dirtyState, $author$project$Types$Dirty) ? ' *' : ''));
		} else {
			return 'Fence';
		}
	}();
		...
		$elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'tag',
					$elm$json$Json$Encode$string('setTitle')),
					_Utils_Tuple2(
					'title',
...
var $author$project$Main$handlePortMessage = F3(
	function (tag, value, model) {
		switch (tag) {
			case 'folderOpened':
				var _v1 = A2($elm$json$Json$Decode$decodeValue, $author$project$Main$dirEntriesDecoder, value);
				if (_v1.$ === 'Ok') {
					var _v2 = _v1.a;
					var path = _v2.a;
					var entries = _v2.b;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								fileTree: A3($author$project$FileTree$handleDirContents, path, entries, model.fileTree)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			...
			case 'dirContents':
				var _v3 = A2($elm$json$Json$Decode$decodeValue, $author$project$Main$dirEntriesDecoder, value);
				if (_v3.$ === 'Ok') {
					var _v4 = _v3.a;
					var path = _v4.a;
					var entries = _v4.b;
			...
			case 'fileContent':
				var _v5 = A2($elm$json$Json$Decode$decodeValue, $author$project$Main$fileContentDecoder, value);
				if (_v5.$ === 'Ok') {
					var _v6 = _v5.a;
					var path = _v6.a;
					var content = _v6.b;
					var newEditor = A3($author$project$Editor$setContent, path, content, model.editor);
					var _v7 = $author$project$Markdown$parse(content);
					var frontmatter = _v7.frontmatter;
					var html = _v7.html;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{editor: newEditor, frontmatter: frontmatter, previewHtml: html}),
						$elm$core$Platform$Cmd$batch(
							_List_fromArray(
								[
									$author$project$Main$setTitleCmd(newEditor),
									$author$project$Main$setDirtyCmd(false)
								])));
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
			case 'fileSaved':
				var newEditor = $author$project$Editor$markClean(model.editor);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{editor: newEditor}),
			...
			case 'fsEvent':
				var _v8 = A2($elm$json$Json$Decode$decodeValue, $author$project$Main$fsEventDecoder, value);
				if (_v8.$ === 'Ok') {
					var _v9 = _v8.a;
					var event = _v9.a;
					var path = _v9.b;
					var shouldReload = (event === 'change') && (_Utils_eq(
						model.editor.filePath,
						$elm$core$Maybe$Just(path)) && _Utils_eq(model.editor.dirtyState, $author$project$Types$Clean));
					var newTree = A3($author$project$FileTree$handleFsEvent, event, path, model.fileTree);
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{fileTree: newTree}),
						shouldReload ? $author$project$Ports$toElectron(
							$elm$json$Json$Encode$object(
								_List_fromArray(
									[
										_Utils_Tuple2(
			...
			case 'saveAndClose':
				var _v10 = $author$project$Main$saveFile(model);
				var newModel = _v10.a;
				var saveCmd = _v10.b;
				return _Utils_Tuple2(
					newModel,
					$elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[
								...
								$elm$core$Task$perform,
								function (_v11) {
									return $author$project$Main$FromElectron(
										$elm$json$Json$Encode$object(
											_List_fromArray(
												[
													_Utils_Tuple2(
													'tag',
													$elm$json$Json$Encode$string('doClose'))
												])));
								},
						...
						$elm$json$Json$Encode$object(
							_List_fromArray(
								[
									_Utils_Tuple2(
									'tag',
									$elm$json$Json$Encode$string('closeWindow'))
								]))));
			default:
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Main$outCmdToValue = function (cmd) {
	switch (cmd.$) {
		case 'CmdOpenFolder':
			return $elm$core$Maybe$Just(
				$elm$json$Json$Encode$object(
				...
				$elm$json$Json$Encode$object(
					_List_fromArray(
						[
							_Utils_Tuple2(
							'tag',
							$elm$json$Json$Encode$string('readDir')),
							_Utils_Tuple2(
							'path',
							$elm$json$Json$Encode$string(path))
						])));
				...
				$elm$json$Json$Encode$object(
					_List_fromArray(
						[
							_Utils_Tuple2(
							'tag',
							$elm$json$Json$Encode$string('watchDir')),
							_Utils_Tuple2(
							'path',
							$elm$json$Json$Encode$string(path))
						])));
				...
				$elm$json$Json$Encode$object(
					_List_fromArray(
						[
							_Utils_Tuple2(
							'tag',
							$elm$json$Json$Encode$string('unwatchDir')),
							_Utils_Tuple2(
							'path',
							$elm$json$Json$Encode$string(path))
						])));
...
var $author$project$Main$outCmdsToPortCmds = function (cmds) {
	return $elm$core$Platform$Cmd$batch(
		A2(
			$elm$core$List$map,
			$author$project$Ports$toElectron,
			A2($elm$core$List$filterMap, $author$project$Main$outCmdToValue, cmds)));
};
var $author$project$Main$treeItemId = function (path) {
	return 'tree-item-' + A3($elm$core$String$replace, '/', '-', path);
};
var $author$project$Editor$update = F2(
	function (msg, model) {
		if (msg.$ === 'ContentChanged') {
			...
			return _Utils_update(
				model,
				{content: content, dirtyState: $author$project$Types$Dirty});
		} else {
			var scrollTop = msg.a;
			return _Utils_update(
				model,
...
var $author$project$FileTree$CmdOpenFolder = {$: 'CmdOpenFolder'};
var $author$project$FileTree$CmdReadDir = function (a) {
	return {$: 'CmdReadDir', a: a};
};
var $author$project$FileTree$CmdReadFile = function (a) {
	return {$: 'CmdReadFile', a: a};
};
var $author$project$FileTree$CmdUnwatchDir = function (a) {
	return {$: 'CmdUnwatchDir', a: a};
};
var $author$project$FileTree$CmdWatchDir = function (a) {
	return {$: 'CmdWatchDir', a: a};
};
var $author$project$FileTree$FileSelected = function (a) {
	return {$: 'FileSelected', a: a};
};
var $author$project$FileTree$Toggle = function (a) {
	return {$: 'Toggle', a: a};
};
var $author$project$FileTree$findEntryType = F2(
	function (targetPath, _v0) {
		var entry = _v0.a;
		if (_Utils_eq(entry.path, targetPath)) {
			return $elm$core$Maybe$Just(entry.fileType);
		} else {
			var _v1 = entry.children;
			if (_v1.$ === 'Just') {
				var children = _v1.a;
				return $elm$core$List$head(
					A2(
						$elm$core$List$filterMap,
						$author$project$FileTree$findEntryType(targetPath),
						children));
			} else {
				return $elm$core$Maybe$Nothing;
			}
...
var $author$project$FileTree$isDirectory = F2(
	function (path, model) {
		var _v0 = model.root;
		if (_v0.$ === 'Nothing') {
			return false;
			...
			var root = _v0.a;
			return _Utils_eq(
				A2($author$project$FileTree$findEntryType, path, root),
				$elm$core$Maybe$Just($author$project$Types$Directory));
		}
	});
var $author$project$FileTree$moveFocusTo = F2(
	function (maybePath, model) {
		if (maybePath.$ === 'Nothing') {
			return _Utils_Tuple2(model, _List_Nil);
		} else {
			var path = maybePath.a;
			return A2($author$project$FileTree$isDirectory, path, model) ? _Utils_Tuple2(
				_Utils_update(
					model,
					{
						focused: $elm$core$Maybe$Just(path)
					}),
				...
				_Utils_update(
					...
					{
						focused: $elm$core$Maybe$Just(path),
						selected: $elm$core$Maybe$Just(path)
					}),
				_List_fromArray(
					[
						$author$project$FileTree$CmdReadFile(path)
					]));
		}
	});
var $author$project$FileTree$nextItem = F2(
...
var $author$project$FileTree$directoriesFirst = F2(
	function (a, b) {
		var _v0 = _Utils_Tuple2(
			$author$project$Types$fileEntryType(a),
			$author$project$Types$fileEntryType(b));
		_v0$2:
		while (true) {
			if (_v0.a.$ === 'Directory') {
				if (_v0.b.$ === 'File') {
		...
		return A2(
			...
			$elm$core$String$toLower(
				$author$project$Types$fileEntryName(a)),
			$elm$core$String$toLower(
				$author$project$Types$fileEntryName(b)));
	});
var $author$project$FileTree$isMarkdownOrDir = function (entry) {
	var _v0 = $author$project$Types$fileEntryType(entry);
	if (_v0.$ === 'Directory') {
		return true;
	} else {
		var name = $elm$core$String$toLower(
			$author$project$Types$fileEntryName(entry));
		return A2($elm$core$String$endsWith, '.md', name) || A2($elm$core$String$endsWith, '.markdown', name);
	}
};
var $elm$core$List$sortWith = _List_sortWith;
var $author$project$FileTree$flattenEntry = F2(
	function (expanded, _v0) {
		var entry = _v0.a;
		var path = entry.path;
		var isExpanded = A2($elm$core$Set$member, path, expanded);
		var isDir = _Utils_eq(entry.fileType, $author$project$Types$Directory);
		return A2(
			$elm$core$List$cons,
			path,
			(isDir && isExpanded) ? A2(
				$elm$core$List$concatMap,
				$author$project$FileTree$flattenEntry(expanded),
				A2(
					$elm$core$List$sortWith,
					$author$project$FileTree$directoriesFirst,
					A2(
						$elm$core$List$filter,
						$author$project$FileTree$isMarkdownOrDir,
						A2($elm$core$Maybe$withDefault, _List_Nil, entry.children)))) : _List_Nil);
	});
var $author$project$FileTree$visiblePaths = function (model) {
	var _v0 = model.root;
	if (_v0.$ === 'Nothing') {
		return _List_Nil;
	} else {
		var root = _v0.a;
		return A2($author$project$FileTree$flattenEntry, model.expanded, root);
	}
};
var $author$project$FileTree$parentOf = F2(
	function (path, model) {
		var paths = $author$project$FileTree$visiblePaths(model);
		var parent = $author$project$FileTree$dirName(path);
		return A2($elm$core$List$member, parent, paths) ? $elm$core$Maybe$Just(parent) : $elm$core$Maybe$Nothing;
	});
var $author$project$FileTree$previousItemHelp = F3(
	function (prev, current, paths) {
		previousItemHelp:
		while (true) {
			if (!paths.b) {
				return $elm$core$Maybe$Nothing;
				...
				if (_Utils_eq(x, current)) {
					...
					var $temp$prev = $elm$core$Maybe$Just(x),
						$temp$current = current,
						$temp$paths = rest;
					prev = $temp$prev;
					current = $temp$current;
					paths = $temp$paths;
					continue previousItemHelp;
				}
			}
		}
	});
var $author$project$FileTree$previousItem = F2(
	function (current, paths) {
		return A3($author$project$FileTree$previousItemHelp, $elm$core$Maybe$Nothing, current, paths);
	});
...
var $author$project$FileTree$update = F2(
	function (msg, model) {
		update:
		while (true) {
			switch (msg.$) {
				case 'OpenFolder':
					return _Utils_Tuple2(
						model,
						_List_fromArray(
							[$author$project$FileTree$CmdOpenFolder]));
				case 'Toggle':
					var path = msg.a;
					return A2($elm$core$Set$member, path, model.expanded) ? _Utils_Tuple2(
						_Utils_update(
							model,
							{
						...
						_List_fromArray(
							[
								$author$project$FileTree$CmdUnwatchDir(path)
							])) : _Utils_Tuple2(
						_Utils_update(
							model,
							{
						...
						_List_fromArray(
							[
								$author$project$FileTree$CmdReadDir(path),
								$author$project$FileTree$CmdWatchDir(path)
							]));
				case 'FileSelected':
					var path = msg.a;
					return _Utils_Tuple2(
				...
				case 'FocusUp':
					...
					if (_v1.$ === 'Nothing') {
						return A2(
							$author$project$FileTree$moveFocusTo,
							$elm$core$List$head(paths),
							model);
					} else {
						var current = _v1.a;
						return A2(
							$author$project$FileTree$moveFocusTo,
							A2($author$project$FileTree$previousItem, current, paths),
							model);
					}
				case 'FocusDown':
					var paths = $author$project$FileTree$visiblePaths(model);
					...
					if (_v2.$ === 'Nothing') {
						...
						return A2(
							$author$project$FileTree$moveFocusTo,
							A2($author$project$FileTree$nextItem, current, paths),
							model);
					}
				case 'FocusLeft':
					var _v3 = model.focused;
					if (_v3.$ === 'Nothing') {
						return _Utils_Tuple2(model, _List_Nil);
					} else {
						var current = _v3.a;
						if (A2($author$project$FileTree$isDirectory, current, model) && A2($elm$core$Set$member, current, model.expanded)) {
							var $temp$msg = $author$project$FileTree$Toggle(current),
								$temp$model = model;
							msg = $temp$msg;
							model = $temp$model;
							continue update;
							...
							return A2(
								$author$project$FileTree$moveFocusTo,
								A2($author$project$FileTree$parentOf, current, model),
								model);
						}
					}
				case 'FocusRight':
					var _v4 = model.focused;
					if (_v4.$ === 'Nothing') {
						return _Utils_Tuple2(model, _List_Nil);
					} else {
						var current = _v4.a;
						if (A2($author$project$FileTree$isDirectory, current, model)) {
							if (A2($elm$core$Set$member, current, model.expanded)) {
								var paths = $author$project$FileTree$visiblePaths(model);
								return A2(
									$author$project$FileTree$moveFocusTo,
									A2($author$project$FileTree$nextItem, current, paths),
				...
				case 'Activate':
					...
					if (_v5.$ === 'Nothing') {
						...
						if (A2($author$project$FileTree$isDirectory, current, model)) {
							...
							var $temp$msg = $author$project$FileTree$FileSelected(current),
								$temp$model = model;
							msg = $temp$msg;
							model = $temp$model;
							continue update;
				...
				case 'FocusFirst':
					return A2(
						$author$project$FileTree$moveFocusTo,
						$elm$core$List$head(
							$author$project$FileTree$visiblePaths(model)),
						model);
				case 'FocusLast':
					var paths = $author$project$FileTree$visiblePaths(model);
					return A2(
		...
		switch (msg.$) {
			...
			case 'ToggleSettings':
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$none);
			case 'SetTheme':
				var themeValue = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{settingsOpen: false, theme: themeValue}),
					$author$project$Ports$toElectron(
						$elm$json$Json$Encode$object(
							_List_fromArray(
								[
									_Utils_Tuple2(
									'tag',
									$elm$json$Json$Encode$string('setTheme')),
									_Utils_Tuple2(
									'theme',
									$elm$json$Json$Encode$string(themeValue))
								]))));
			case 'CloseSettings':
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 'FileTreeMsg':
				var subMsg = msg.a;
				var _v1 = A2($author$project$FileTree$update, subMsg, model.fileTree);
				var newTree = _v1.a;
				var outCmds = _v1.b;
				var focusCmd = function () {
					var _v2 = newTree.focused;
					if (_v2.$ === 'Just') {
						var path = _v2.a;
						return (!_Utils_eq(newTree.focused, model.fileTree.focused)) ? A2(
							$elm$core$Task$attempt,
							function (_v3) {
								return $author$project$Main$NoOp;
							},
							$elm$browser$Browser$Dom$focus(
								$author$project$Main$treeItemId(path))) : $elm$core$Platform$Cmd$none;
					} else {
				...
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[
								$author$project$Main$outCmdsToPortCmds(outCmds),
								focusCmd
							])));
			case 'EditorMsg':
				var subMsg = msg.a;
				var newEditor = A2($author$project$Editor$update, subMsg, model.editor);
				if (subMsg.$ === 'ContentChanged') {
					var gen = model.debounceGeneration + 1;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{debounceGeneration: gen, editor: newEditor}),
						$elm$core$Platform$Cmd$batch(
							_List_fromArray(
								[
									A2(
									$elm$core$Task$perform,
									function (_v5) {
										return $author$project$Main$DebouncedParse(gen);
									},
									$elm$core$Process$sleep(150)),
									$author$project$Main$setTitleCmd(newEditor),
									$author$project$Main$setDirtyCmd(true)
								])));
				} else {
					return _Utils_Tuple2(
						_Utils_update(
			...
			case 'DebouncedParse':
				var gen = msg.a;
				if (_Utils_eq(gen, model.debounceGeneration)) {
					var _v6 = $author$project$Markdown$parse(model.editor.content);
					var frontmatter = _v6.frontmatter;
					var html = _v6.html;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{frontmatter: frontmatter, previewHtml: html}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
			case 'KeyDown':
				...
				var metaKey = msg.b;
				var ctrlKey = msg.c;
				return ((key === 's') && (metaKey || ctrlKey)) ? $author$project$Main$saveFile(model) : _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			default:
				var value = msg.a;
				var _v7 = A2(
				...
				if (_v7.$ === 'Ok') {
					var tag = _v7.a;
					return A3($author$project$Main$handlePortMessage, tag, value, model);
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
		}
...
var $author$project$Main$FileTreeMsg = function (a) {
	return {$: 'FileTreeMsg', a: a};
};
...
var $author$project$Editor$ContentChanged = function (a) {
	return {$: 'ContentChanged', a: a};
};
var $author$project$Editor$ScrollChanged = function (a) {
	return {$: 'ScrollChanged', a: a};
};
...
var $author$project$Editor$baseName = function (path) {
	return A2(
		$elm$core$Maybe$withDefault,
		path,
		$elm$core$List$head(
...
var $author$project$Editor$headerText = function (model) {
	var _v0 = model.filePath;
	if (_v0.$ === 'Just') {
		var path = _v0.a;
		return _Utils_ap(
			$author$project$Editor$baseName(path),
			_Utils_eq(model.dirtyState, $author$project$Types$Dirty) ? ' *' : '');
	} else {
		return 'Editor';
	}
};
var $author$project$Editor$findClosingHelper = F4(
	function (delimiter, delimLen, str, pos) {
		findClosingHelper:
		while (true) {
			if (_Utils_cmp(
				pos,
				...
				if (_Utils_eq(
					A3($elm$core$String$slice, pos, pos + delimLen, str),
					delimiter)) {
					return $elm$core$Maybe$Just(
						_Utils_Tuple2(
							A2($elm$core$String$left, pos, str),
							A2($elm$core$String$dropLeft, pos + delimLen, str)));
				} else {
					var $temp$delimiter = delimiter,
						$temp$delimLen = delimLen,
						$temp$str = str,
						$temp$pos = pos + 1;
					delimiter = $temp$delimiter;
					delimLen = $temp$delimLen;
					str = $temp$str;
					pos = $temp$pos;
					continue findClosingHelper;
				}
...
var $author$project$Editor$findClosing = F2(
	function (delimiter, str) {
		var delimLen = $elm$core$String$length(delimiter);
		return A4($author$project$Editor$findClosingHelper, delimiter, delimLen, str, 0);
	});
var $author$project$Editor$findNextSpecial = function (str) {
	var helper = F2(
		function (index, cs) {
			helper:
			while (true) {
				if (!cs.b) {
					...
					if (_Utils_eq(
						...
						var $temp$index = index + 1,
							$temp$cs = A2($elm$core$List$drop, 1, cs);
						index = $temp$index;
						cs = $temp$cs;
						continue helper;
					}
	...
	return A2(helper, 0, chars);
};
var $author$project$Editor$parseLinkMarkdown = function (str) {
	var _v0 = A2($elm$core$String$indexes, '](', str);
	if (_v0.b) {
		var i = _v0.a;
		var linkText = A2($elm$core$String$left, i, str);
		var afterBracket = A2($elm$core$String$dropLeft, i + 2, str);
		var _v1 = A2($elm$core$String$indexes, ')', afterBracket);
		if (_v1.b) {
			var j = _v1.a;
			return $elm$core$Maybe$Just(
				_Utils_Tuple3(
					linkText,
					A2($elm$core$String$left, j, afterBracket),
					A2($elm$core$String$dropLeft, j + 1, afterBracket)));
		} else {
			return $elm$core$Maybe$Nothing;
		}
	} else {
...
var $author$project$Editor$parseInline = F2(
		...
		while (true) {
			if ($elm$core$String$isEmpty(remaining)) {
				...
				if (A2($elm$core$String$startsWith, '**', remaining)) {
					var _v0 = A2(
						$author$project$Editor$findClosing,
						'**',
						A2($elm$core$String$dropLeft, 2, remaining));
					if (_v0.$ === 'Just') {
						var _v1 = _v0.a;
						var inner = _v1.a;
						var rest = _v1.b;
						var $temp$remaining = rest,
							...
							A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('md-bold-marker')
									]),
								_List_fromArray(
									[
						...
						remaining = $temp$remaining;
						acc = $temp$acc;
						continue parseInline;
					} else {
						var $temp$remaining = A2($elm$core$String$dropLeft, 2, remaining),
							$temp$acc = A2(
							$elm$core$List$cons,
							$elm$html$Html$text('**'),
							acc);
					...
					if (A2($elm$core$String$startsWith, '*', remaining)) {
						...
						if (_v2.$ === 'Just') {
							...
							var $temp$remaining = rest,
								...
								A2(
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('md-italic-marker')
										]),
									_List_fromArray(
										[
											$elm$html$Html$text('*' + (inner + '*'))
						...
						if (A2($elm$core$String$startsWith, '`', remaining)) {
							...
							if (A2($elm$core$String$startsWith, '[', remaining)) {
								var _v6 = $author$project$Editor$parseLinkMarkdown(
									A2($elm$core$String$dropLeft, 1, remaining));
								if (_v6.$ === 'Just') {
									var _v7 = _v6.a;
									var linkText = _v7.a;
									...
									var $temp$remaining = rest,
										...
										A2(
											...
											_List_fromArray(
												[
													$elm$html$Html$Attributes$class('md-link')
												]),
											_List_fromArray(
												[
													$elm$html$Html$text('[' + (linkText + ('](' + (url + ')'))))
												])),
										acc);
									remaining = $temp$remaining;
									acc = $temp$acc;
								...
								var nextSpecial = $author$project$Editor$findNextSpecial(remaining);
								var _v8 = function () {
									if (!nextSpecial) {
										return _Utils_Tuple2(
										...
										var n = nextSpecial;
										return _Utils_Tuple2(
											A2($elm$core$String$left, n, remaining),
											A2($elm$core$String$dropLeft, n, remaining));
									}
								}();
								var plain = _v8.a;
								var rest = _v8.b;
...
var $author$project$Editor$highlightInline = function (line) {
	var parts = A2($author$project$Editor$parseInline, line, _List_Nil);
	return A2($elm$html$Html$span, _List_Nil, parts);
};
var $author$project$Editor$isOrderedListItem = function (line) {
	var _v0 = $elm$core$String$toInt(
		A2($elm$core$String$left, 1, line));
	if (_v0.$ === 'Just') {
		return A2(
			$elm$core$String$contains,
			'. ',
			A2($elm$core$String$left, 5, line));
	} else {
		return false;
	}
};
var $author$project$Editor$highlightLine = function (line) {
	var trimmed = $elm$core$String$trimLeft(line);
	var leadingSpaces = $elm$core$String$length(line) - $elm$core$String$length(trimmed);
			...
			if (A2($elm$core$String$startsWith, '### ', trimmed)) {
				...
				if (A2($elm$core$String$startsWith, '#### ', trimmed)) {
					return A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('md-h4')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(line)
					...
					if (A2($elm$core$String$startsWith, '##### ', trimmed)) {
						return A2(
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('md-h5')
								]),
							_List_fromArray(
								[
									$elm$html$Html$text(line)
						...
						if (A2($elm$core$String$startsWith, '###### ', trimmed)) {
							return A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('md-h6')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text(line)
							...
							if (A2($elm$core$String$startsWith, '```', trimmed)) {
								return A2(
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('md-code-fence')
										]),
									_List_fromArray(
										[
											$elm$html$Html$text(line)
								...
								if (A2($elm$core$String$startsWith, '>', trimmed)) {
									return A2(
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$class('md-blockquote-marker')
											]),
										_List_fromArray(
											[
												$elm$html$Html$text(line)
									...
									if (A2($elm$core$String$startsWith, '- ', trimmed) || (A2($elm$core$String$startsWith, '* ', trimmed) || A2($elm$core$String$startsWith, '+ ', trimmed))) {
										return A2(
											$elm$html$Html$span,
											_List_Nil,
											_List_fromArray(
												[
													$elm$html$Html$text(
													A2($elm$core$String$left, leadingSpaces, line)),
													A2(
													$elm$html$Html$span,
													_List_fromArray(
														[
															$elm$html$Html$Attributes$class('md-list-marker')
														]),
													_List_fromArray(
														[
															$elm$html$Html$text(
															A2($elm$core$String$left, 2, trimmed))
														])),
													$author$project$Editor$highlightInline(
													A2($elm$core$String$dropLeft, 2, trimmed))
												]));
									} else {
										if ($author$project$Editor$isOrderedListItem(trimmed)) {
												...
												_List_fromArray(
													[
														...
														_List_fromArray(
															[
																$elm$html$Html$text(
																A2($elm$core$String$left, markerEnd, trimmed))
															])),
														$author$project$Editor$highlightInline(
														A2($elm$core$String$dropLeft, markerEnd, trimmed))
													]));
										} else {
											if (A2($elm$core$String$startsWith, '---', trimmed) || (A2($elm$core$String$startsWith, '***', trimmed) || A2($elm$core$String$startsWith, '___', trimmed))) {
												return A2(
													$elm$html$Html$span,
													_List_fromArray(
														[
												...
												return $author$project$Editor$highlightInline(line);
											}
										}
									}
								}
...
var $author$project$Editor$highlightMarkdown = function (content) {
	return A2(
		$elm$core$List$intersperse,
		$elm$html$Html$text('\n'),
		A2(
			$elm$core$List$map,
			$author$project$Editor$highlightLine,
			A2($elm$core$String$split, '\n', content)));
};
...
var $author$project$Editor$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('editor-pane')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text(
								$author$project$Editor$headerText(model))
							]))
					])),
				A2(
				$elm$html$Html$div,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('editor-highlight'),
								A2(
								$elm$html$Html$Attributes$style,
								'transform',
								'translateY(-' + ($elm$core$String$fromFloat(model.scrollTop) + 'px)'))
							]),
						_List_fromArray(
							[
								A2(
								$elm$html$Html$code,
								_List_Nil,
								$author$project$Editor$highlightMarkdown(model.content))
							])),
						A2(
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Attributes$placeholder('Open a file to start editing...'),
								$elm$html$Html$Attributes$value(model.content),
								$elm$html$Html$Events$onInput($author$project$Editor$ContentChanged),
								A2(
								$elm$html$Html$Events$on,
								'scroll',
								A2(
									$elm$json$Json$Decode$map,
									$author$project$Editor$ScrollChanged,
									A2(
										$elm$json$Json$Decode$at,
										_List_fromArray(
											['target', 'scrollTop']),
...
var $author$project$FileTree$OpenFolder = {$: 'OpenFolder'};
...
var $author$project$FileTree$Activate = {$: 'Activate'};
var $author$project$FileTree$FocusDown = {$: 'FocusDown'};
var $author$project$FileTree$FocusFirst = {$: 'FocusFirst'};
var $author$project$FileTree$FocusLast = {$: 'FocusLast'};
var $author$project$FileTree$FocusLeft = {$: 'FocusLeft'};
var $author$project$FileTree$FocusRight = {$: 'FocusRight'};
var $author$project$FileTree$FocusUp = {$: 'FocusUp'};
var $author$project$FileTree$treeKeyDecoder = function (_v0) {
	return A2(
		$elm$json$Json$Decode$andThen,
		function (key) {
			switch (key) {
				case 'ArrowUp':
					return $elm$json$Json$Decode$succeed(
						_Utils_Tuple2($author$project$FileTree$FocusUp, true));
				case 'ArrowDown':
					return $elm$json$Json$Decode$succeed(
						_Utils_Tuple2($author$project$FileTree$FocusDown, true));
				case 'ArrowLeft':
					return $elm$json$Json$Decode$succeed(
						_Utils_Tuple2($author$project$FileTree$FocusLeft, true));
				case 'ArrowRight':
					return $elm$json$Json$Decode$succeed(
						_Utils_Tuple2($author$project$FileTree$FocusRight, true));
				case 'Enter':
					return $elm$json$Json$Decode$succeed(
						_Utils_Tuple2($author$project$FileTree$Activate, true));
				case ' ':
					return $elm$json$Json$Decode$succeed(
						_Utils_Tuple2($author$project$FileTree$Activate, true));
				case 'Home':
					return $elm$json$Json$Decode$succeed(
						_Utils_Tuple2($author$project$FileTree$FocusFirst, true));
				case 'End':
					return $elm$json$Json$Decode$succeed(
						_Utils_Tuple2($author$project$FileTree$FocusLast, true));
				default:
					return $elm$json$Json$Decode$fail('not a tree key');
			}
		},
		A2($elm$json$Json$Decode$field, 'key', $elm$json$Json$Decode$string));
};
...
var $author$project$Icon$chevronDown = function (size) {
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$svg$Svg$Attributes$d('M12 15.5a1 1 0 0 1-.71-.29l-4-4a1 1 0 1 1 1.42-1.42L12 13.1l3.3-3.18a1 1 0 1 1 1.38 1.44l-4 3.86a1 1 0 0 1-.68.28z')
					]),
				_List_Nil)
			]));
};
var $author$project$Icon$chevronRight = function (size) {
	return A2(
		$author$project$Icon$icon,
		size,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$svg$Svg$Attributes$d('M10.5 17a1 1 0 0 1-.71-.29 1 1 0 0 1 0-1.42L13.1 12 9.92 8.69a1 1 0 0 1 0-1.41 1 1 0 0 1 1.42 0l3.86 4a1 1 0 0 1 0 1.4l-4 4a1 1 0 0 1-.7.32z')
					]),
				_List_Nil)
			]));
};
var $author$project$Types$fileEntryChildren = function (_v0) {
	var e = _v0.a;
	return e.children;
};
var $author$project$Icon$fileText = function (size) {
	return A2(
		$author$project$Icon$icon,
		size,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$svg$Svg$Attributes$d('M19.74 7.33l-4.44-5a1 1 0 0 0-.74-.33h-8A2.53 2.53 0 0 0 4 4.5v15A2.53 2.53 0 0 0 6.56 22h10.88A2.53 2.53 0 0 0 20 19.5V8a1 1 0 0 0-.26-.67zM9 12h3a1 1 0 0 1 0 2H9a1 1 0 0 1 0-2zm6 6H9a1 1 0 0 1 0-2h6a1 1 0 0 1 0 2zm-.29-10a.79.79 0 0 1-.71-.85V4l3.74 4z')
					]),
				_List_Nil)
			]));
};
...
var $author$project$FileTree$treeItemId = function (path) {
	return 'tree-item-' + A3($elm$core$String$replace, '/', '-', path);
};
var $author$project$FileTree$viewEntry = F3(
	function (model, depth, entry) {
		var isDir = _Utils_eq(
			$author$project$Types$fileEntryType(entry),
			$author$project$Types$Directory);
		var indent = A2(
			$elm$html$Html$Attributes$style,
			'padding-left',
			$elm$core$String$fromInt(12 + (depth * 16)) + 'px');
		var entryPath = $author$project$Types$fileEntryPath(entry);
		var isExpanded = A2($elm$core$Set$member, entryPath, model.expanded);
		var isFocused = _Utils_eq(
			model.focused,
			$elm$core$Maybe$Just(entryPath));
		var isSelected = _Utils_eq(
			model.selected,
			$elm$core$Maybe$Just(entryPath));
		var entryName = $author$project$Types$fileEntryName(entry);
		var _v0 = $author$project$Types$fileEntryType(entry);
		if (_v0.$ === 'Directory') {
			return A2(
				$elm$html$Html$li,
				_List_fromArray(
					[
						A2($elm$html$Html$Attributes$attribute, 'role', 'treeitem'),
						A2(
						$elm$html$Html$Attributes$attribute,
						'aria-expanded',
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('file-tree-item'),
								$elm$html$Html$Attributes$classList(
								_List_fromArray(
									[
								...
								$author$project$FileTree$treeItemId(entryPath)),
								$elm$html$Html$Attributes$tabindex(
								isFocused ? 0 : (-1)),
								indent,
								$elm$html$Html$Events$onClick(
								$author$project$FileTree$Toggle(entryPath))
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										isExpanded ? $author$project$Icon$chevronDown(16) : $author$project$Icon$chevronRight(16)
									])),
								A2(
								$elm$html$Html$span,
								_List_fromArray(
								...
								_List_fromArray(
									[
										$elm$html$Html$text(entryName)
									]))
							])),
						function () {
						if (isExpanded) {
							var _v1 = $author$project$Types$fileEntryChildren(entry);
							if (_v1.$ === 'Just') {
								var children = _v1.a;
								return A2(
									$elm$html$Html$ul,
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('file-tree-children'),
											A2($elm$html$Html$Attributes$attribute, 'role', 'group')
										]),
									A2(
										$elm$core$List$map,
										A2($author$project$FileTree$viewEntry, model, depth + 1),
										A2(
											$elm$core$List$sortWith,
											$author$project$FileTree$directoriesFirst,
											A2($elm$core$List$filter, $author$project$FileTree$isMarkdownOrDir, children))));
							} else {
								return $elm$html$Html$text('');
							}
						} else {
					...
					[
						...
						_List_fromArray(
							[
								...
								indent,
								$elm$html$Html$Events$onClick(
								$author$project$FileTree$FileSelected(entryPath))
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$author$project$Icon$fileText(16)
									])),
								A2(
								$elm$html$Html$span,
								_List_fromArray(
...
var $author$project$FileTree$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('open-folder-btn'),
								$elm$html$Html$Events$onClick($author$project$FileTree$OpenFolder)
							]),
						_List_fromArray(
							[
						...
						if (_v0.$ === 'Nothing') {
							...
							return A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('file-tree'),
										A2($elm$html$Html$Attributes$attribute, 'role', 'tree'),
										A2($elm$html$Html$Attributes$attribute, 'aria-label', 'File tree'),
										A2(
										$elm$html$Html$Events$preventDefaultOn,
										'keydown',
										$author$project$FileTree$treeKeyDecoder(model))
									]),
								_List_fromArray(
									[
										A3($author$project$FileTree$viewEntry, model, 0, root)
									]));
						}
					}()
					]))
...
var $author$project$Preview$viewField = function (_v2) {
	var key = _v2.a;
	var value = _v2.b;
	return _List_fromArray(
		[
			...
			_List_fromArray(
				[
					$author$project$Preview$viewValue(value)
				]))
		]);
};
var $author$project$Preview$viewValue = function (value) {
	switch (value.$) {
		case 'String_':
			var s = value.a;
		...
		case 'Null_':
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('fm-null')
					]),
				_List_fromArray(
					[
					...
					function (item) {
						if (item.$ === 'String_') {
							...
							return A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('fm-tag')
									]),
								_List_fromArray(
									[
							...
							return A2(
								...
								_List_fromArray(
									[
										$author$project$Preview$viewValue(item)
									]));
						}
					},
					items));
		default:
			...
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('frontmatter-grid')
					]),
				A2($elm$core$List$concatMap, $author$project$Preview$viewField, fields));
	}
};
var $author$project$Preview$viewFrontmatter = function (maybeFm) {
	if ((maybeFm.$ === 'Just') && (maybeFm.a.$ === 'Object_')) {
		var fields = maybeFm.a.a;
		return _List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('frontmatter')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$text(
								'Metadata (' + ($elm$core$String$fromInt(
									$elm$core$List$length(fields)) + ' fields)'))
							])),
						A2(
						$elm$html$Html$dl,
						_List_fromArray(
...
var $author$project$Preview$welcomeView = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('welcome-title')
				]),
			_List_fromArray(
				[
					$elm$html$Html$text('Fence')
				])),
			A2(
			$elm$html$Html$p,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('welcome-subtitle')
				]),
			_List_fromArray(
				[
					$elm$html$Html$text('A split-view markdown editor')
				])),
			A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('welcome-hints')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Open a folder to browse your markdown files')
						])),
					A2(
					$elm$html$Html$p,
					_List_Nil,
					_List_fromArray(
						[
							$elm$html$Html$text('Click a .md file in the sidebar to start editing')
						])),
					A2(
					$elm$html$Html$ul,
					_List_Nil,
...
var $author$project$Preview$view = F2(
	function (frontmatter, renderedHtml) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('preview-pane')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							...
							$elm$core$List$isEmpty(renderedHtml) ? _List_fromArray(
								[$author$project$Preview$welcomeView]) : _Utils_ap(
								$author$project$Preview$viewFrontmatter(frontmatter),
								renderedHtml))
						]))
				]));
	});
...
var $author$project$Icon$settings = function (size) {
	return A2(
		$author$project$Icon$icon,
		size,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$svg$Svg$Attributes$d('M20.32 9.37h-1.09c-.14 0-.24-.11-.3-.26a.34.34 0 0 1 0-.37l.81-.74a1.63 1.63 0 0 0 .5-1.18 1.67 1.67 0 0 0-.5-1.19L18.4 4.26a1.67 1.67 0 0 0-2.37 0l-.77.74a.38.38 0 0 1-.41 0 .34.34 0 0 1-.22-.29V3.68A1.68 1.68 0 0 0 13 2h-1.94a1.69 1.69 0 0 0-1.69 1.68v1.09c0 .14-.11.24-.26.3a.34.34 0 0 1-.37 0L8 4.26a1.72 1.72 0 0 0-1.19-.5 1.65 1.65 0 0 0-1.18.5L4.26 5.6a1.67 1.67 0 0 0 0 2.4l.74.74a.38.38 0 0 1 0 .41.34.34 0 0 1-.29.22H3.68A1.68 1.68 0 0 0 2 11.05v1.89a1.69 1.69 0 0 0 1.68 1.69h1.09c.14 0 .24.11.3.26a.34.34 0 0 1 0 .37l-.81.74a1.72 1.72 0 0 0-.5 1.19 1.66 1.66 0 0 0 .5 1.19l1.34 1.36a1.67 1.67 0 0 0 2.37 0l.77-.74a.38.38 0 0 1 .41 0 .34.34 0 0 1 .22.29v1.09A1.68 1.68 0 0 0 11.05 22h1.89a1.69 1.69 0 0 0 1.69-1.68v-1.09c0-.14.11-.24.26-.3a.34.34 0 0 1 .37 0l.76.77a1.72 1.72 0 0 0 1.19.5 1.65 1.65 0 0 0 1.18-.5l1.34-1.34a1.67 1.67 0 0 0 0-2.37l-.73-.73a.34.34 0 0 1 0-.37.34.34 0 0 1 .29-.22h1.09A1.68 1.68 0 0 0 22 13v-1.94a1.69 1.69 0 0 0-1.68-1.69zM12 15.5a3.5 3.5 0 1 1 3.5-3.5 3.5 3.5 0 0 1-3.5 3.5z')
					]),
				_List_Nil)
			]));
};
...
var $author$project$Main$themes = _List_fromArray(
	[
		_Utils_Tuple2('', 'Catppuccin Mocha'),
		_Utils_Tuple2('light', 'Catppuccin Latte'),
		_Utils_Tuple2('github-dark', 'GitHub Dark'),
		_Utils_Tuple2('vscode-dark', 'VS Code Dark+'),
		_Utils_Tuple2('fleet-dark', 'Fleet Dark')
	]);
var $author$project$Main$SetTheme = function (a) {
	return {$: 'SetTheme', a: a};
};
var $author$project$Icon$checkmark = function (size) {
	return A2(
		$author$project$Icon$icon,
		size,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$svg$Svg$Attributes$d('M9.86 18a1 1 0 0 1-.73-.32l-4.86-5.17a1 1 0 1 1 1.46-1.37l4.12 4.39 8.41-9.2a1 1 0 1 1 1.48 1.34l-9.14 10a1 1 0 0 1-.73.33z')
					]),
				_List_Nil)
			]));
};
var $author$project$Main$viewThemeItem = F2(
	function (currentTheme, _v0) {
		var themeValue = _v0.a;
		var displayName = _v0.b;
		var isActive = _Utils_eq(currentTheme, themeValue);
		return A2(
			$elm$html$Html$button,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('settings-dropdown-item'),
					$elm$html$Html$Attributes$classList(
					_List_fromArray(
						[
					...
					$elm$html$Html$Events$onClick(
					$author$project$Main$SetTheme(themeValue))
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('settings-dropdown-check')
						]),
					_List_fromArray(
						[
							isActive ? $author$project$Icon$checkmark(14) : $elm$html$Html$text('')
						])),
					$elm$html$Html$text(displayName)
				]));
	});
var $author$project$Main$viewSettingsDropdown = function (currentTheme) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('settings-backdrop'),
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('settings-dropdown')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('settings-dropdown-label')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Theme')
						...
						A2(
							$elm$core$List$map,
							$author$project$Main$viewThemeItem(currentTheme),
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('titlebar-traffic-pad')
					]),
				_List_Nil),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('titlebar-title')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('titlebar-app-name')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Fence')
							...
							return A2(
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$class('titlebar-separator')
											]),
										_List_fromArray(
											[
												$elm$html$Html$text(' — ')
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$class('titlebar-filename')
											]),
										_List_fromArray(
											[
												$elm$html$Html$text(
												_Utils_ap(
													$author$project$Main$baseName(path),
													_Utils_eq(model.editor.dirtyState, $author$project$Types$Dirty) ? ' *' : ''))
											]))
									]));
						} else {
							return $elm$html$Html$text('');
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('titlebar-actions')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('settings-btn'),
								$elm$html$Html$Events$onClick($author$project$Main$ToggleSettings)
							]),
						_List_fromArray(
							[
								$author$project$Icon$settings(16)
							])),
						model.settingsOpen ? $author$project$Main$viewSettingsDropdown(model.theme) : $elm$html$Html$text('')
					]))
			]));
};
					...
					[
						...
						_List_fromArray(
							[
								A2(
								$elm$html$Html$map,
								$author$project$Main$FileTreeMsg,
								$author$project$FileTree$view(model.fileTree)),
								A2(
								$elm$html$Html$map,
								$author$project$Main$EditorMsg,
								$author$project$Editor$view(model.editor)),
								A2($author$project$Preview$view, model.frontmatter, model.previewHtml)
							]))
					]))
			]));
};
