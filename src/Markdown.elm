...
highlighters =
    ...
    , ( [ "c", "h" ], SyntaxHighlight.c )
    , ( [ "cpp", "c++", "cc", "cxx", "hpp", "hxx" ], SyntaxHighlight.cpp )
    , ( [ "kotlin", "groovy" ], SyntaxHighlight.kotlin )
    , ( [ "java" ], SyntaxHighlight.java )
    , ( [ "csharp", "cs", "c#" ], SyntaxHighlight.csharp )
    , ( [ "swift" ], SyntaxHighlight.swift )
    , ( [ "scala", "sc" ], SyntaxHighlight.scala )
