module SyntaxHighlight.Language.TypeScript exposing
    ( Syntax(..)
    , syntaxToStyle
    , toLines
    , toRevTokens
...
keywordParser revTokens n =
    ...
    else if isTypeKeyword n then
        succeed (( T.C TypeKeyword, n ) :: revTokens)
...
classDeclarationLoop revTokens =
    oneOf
        ...
        , chompIfThenWhile isIdentifierNameChar
            ...
            |> andThen
                (\n ->
                    if n == "extends" || n == "implements" then
...
quoteDelimiter =
    ...
    , innerParsers = [ lineBreakList, tsEscapable ]
